...
public class GT_ItemIterator implements Runnable {
    ...
    public void run() {
        ...
        if (null != (tStack = GT_ModHandler.getRecipeOutput(
            new ItemStack[] { tStack2 = GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Bronze, 1L), tStack2,
                tStack2, tStack2, null, tStack2, tStack2, tStack2, tStack2 }))) {
        ...
        if (null != (tStack = GT_ModHandler.getRecipeOutput(
            new ItemStack[] { tStack2 = GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Bronze, 1L), tStack2,
                tStack2, tStack2, null, tStack2, tStack2, tStack2, tStack2 }))) {
        ...
        ItemStack tStack3;
        if (null != (tStack = GT_ModHandler.getRecipeOutput(
            new ItemStack[] { tStack2 = GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Iron, 1L),
                tStack3 = new ItemStack(Blocks.glass, 1, 0), tStack2, tStack3,
                GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Gold, 1L), tStack3, tStack2, tStack3,
                tStack2 }))) {
            GT_ModHandler.addPulverisationRecipe(
                tStack,
        ...
        if (null != (tStack = GT_ModHandler.getRecipeOutput(
            new ItemStack[] { tStack2 = GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1L),
                tStack3 = new ItemStack(Blocks.glass, 1, 0), tStack2, tStack3,
                GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Gold, 1L), tStack3, tStack2, tStack3,
                tStack2 }))) {
            GT_ModHandler.addPulverisationRecipe(
        ...
        GregTech_API.registerScrewdriver(
            GT_ModHandler.getRecipeOutput(
                new ItemStack[] { null, new ItemStack(Items.iron_ingot, 1), null, new ItemStack(Items.stick, 1) }));
        GregTech_API.registerScrewdriver(
            GT_ModHandler.getRecipeOutput(
                new ItemStack[] { new ItemStack(Items.iron_ingot, 1), null, null, null,
        ...
        GT_Values.RA.addCannerRecipe(
            ...
            ItemList.IC2_Food_Can_Spoiled.get(1L, new Object[0]),
            null,
            200,
            1);
        GT_Values.RA.addCannerRecipe(
            ...
            1);
        GT_Values.RA.addCannerRecipe(
            ItemList.Food_Poisonous_Potato.get(2L, new Object[0]),
            ItemList.IC2_Food_Can_Empty.get(1L, new Object[0]),
            ItemList.IC2_Food_Can_Spoiled.get(1L, new Object[0]),
            null,
            100,
        ...
        GT_Values.RA.addCannerRecipe(
            ...
            ItemList.IC2_Food_Can_Empty.get(12L, new Object[0]),
            ItemList.IC2_Food_Can_Filled.get(12L, new Object[0]),
            null,
            600,
            1);
        GT_Values.RA.addCannerRecipe(
            new ItemStack(Items.mushroom_stew, 1, 32767),
            ItemList.IC2_Food_Can_Empty.get(6L, new Object[0]),
            ItemList.IC2_Food_Can_Filled.get(6L, new Object[0]),
                    ...
                    if ((tName = tItem.getUnlocalizedName()) != null) {
                        ...
                        if (((tItem instanceof ItemFood)) && (tItem != ItemList.IC2_Food_Can_Filled.getItem())
                            ...
                            if (tFoodValue > 0) {
                                GT_Values.RA.addCannerRecipe(
                                    ...
                                    ItemList.IC2_Food_Can_Empty.get(tFoodValue, new Object[0]),
                                    ItemList.IC2_Food_Can_Filled.get(tFoodValue, new Object[0]),
                        ...
                        if ((tName.equals("item.ItemSensorLocationCard"))
                            ...
                            GT_Values.RA.addAssemblerRecipe(
                                new ItemStack(tItem, 1, 32767),
                                null,
                                ItemList.Circuit_Basic.get(2L, new Object[0]),
                                200,
                                32);
                        }
                        if (tName.equals("item.ItemTimeCard")) {
                            GT_Values.RA.addAssemblerRecipe(
                                new ItemStack(tItem, 1, 32767),
                                null,
                                ItemList.Circuit_Basic.get(1L, new Object[0]),
                                100,
                                32);
                        }
