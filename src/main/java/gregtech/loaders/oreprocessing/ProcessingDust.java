        ...
        switch (aPrefix) {
            case dust:
                    ...
                    if (aMaterial.mBlastFurnaceRequired) {
                        ...
                        GT_Values.RA.addBlastRecipe(
                            ...
                            aMaterial.mBlastFurnaceTemp > 1750
                                ? GT_OreDictUnificator.get(OrePrefixes.ingotHot, aMaterial.mSmeltInto, tDustStack, 1L)
                ...
                switch (aMaterial.mName) {
                    ...
                    // break;
                    // case "Magnetite": case "VanadiumMagnetite": case "BasalticMineralSand": case
                    // "GraniticMineralSand":
                    // GT_ModHandler.addSmeltingRecipe(GT_Utility.copyAmount(1L, new Object[]{aStack}),
                ...
                if (aMaterial.mBlastFurnaceRequired) {
                    GT_Values.RA.addBlastRecipe(
                        ...
                        aMaterial.mBlastFurnaceTemp > 1750 ? GT_OreDictUnificator.get(
                            ...
                            1L) : GT_OreDictUnificator.get(OrePrefixes.ingot, aMaterial.mSmeltInto, 1L),
                        null,
                        (int) Math.max(aMaterial.getMass() / 40L, 1L) * aMaterial.mBlastFurnaceTemp,
                        120,
                        aMaterial.mBlastFurnaceTemp);
                } else {
                    gregtech.api.util.GT_ModHandler.addAlloySmelterRecipe(
                        GT_Utility.copyAmount(4L, new Object[] { aStack }),
            ...
            case dustTiny:
                ...
                if (!aMaterial.contains(gregtech.api.enums.SubTag.NO_SMELTING)) {
                    if (aMaterial.mBlastFurnaceRequired) {
                        ...
                        GT_ModHandler.addSmeltingRecipe(
                            GT_Utility.copyAmount(1L, new Object[] { aStack }),
                            GT_OreDictUnificator.get(OrePrefixes.nugget, aMaterial.mSmeltInto, 1L));
