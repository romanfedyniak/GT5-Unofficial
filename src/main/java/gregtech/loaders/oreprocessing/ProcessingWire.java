...
public class ProcessingWire implements gregtech.api.interfaces.IOreRecipeRegistrator {
    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName,
            ...
            case wireGt01:
                ...
                if (!aMaterial.contains(gregtech.api.enums.SubTag.NO_SMASHING)) {
                    ...
                    GT_Values.RA.addWiremillRecipe(
                        ...
                        GT_Utility.copy(
                            new Object[] { GT_Utility.copyAmount(2L, aStack),
                    ...
                    GT_Values.RA.addWiremillRecipe(
                        ...
                        GT_Utility.copy(
                            new Object[] { aStack, GT_OreDictUnificator.get(OrePrefixes.wireFine, aMaterial, 4L) }),
                        50,
                        4);
                }
                ...
                GT_Values.RA.addAssemblerRecipe(
                    ...
                    ItemList.Circuit_Integrated.getWithDamage(0L, 12L, new Object[0]),
                    GT_OreDictUnificator.get(OrePrefixes.wireGt12, aMaterial, 1L),
                    400,
                    8);
                GT_Values.RA.addAssemblerRecipe(
                    GT_Utility.copyAmount(16L, new Object[] { aStack }),
                    ItemList.Circuit_Integrated.getWithDamage(0L, 16L, new Object[0]),
            ...
            case wireGt16:
                ...
                if (GT_Mod.gregtechproxy.mAE2Integration) {
                    Api.INSTANCE.registries()
                        .p2pTunnel()
                        .addNewAttunement(aStack, TunnelType.IC2_POWER);
                }
                return;
            default:
                GT_Log.err.println(
        ...
        switch (aMaterial.mName) {
            case "RedAlloy":
                ...
                GT_ModHandler.addShapelessCraftingRecipe(
                    ...
                    craftingListPaper.toArray());
                GT_Values.RA.addBoxingRecipe(
                    GT_Utility.copyAmount(1L, new Object[] { aStack }),
                    GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Paper, costMultiplier),
                    GT_OreDictUnificator.get(correspondingCable, aMaterial, 1L),
                    100,
                    8);
            case "Cobalt":
            ...
            case "SolderingAlloy":
                ...
                GT_ModHandler.addShapelessCraftingRecipe(
                    GT_OreDictUnificator.get(correspondingCable, aMaterial, 1L),
                    craftingListCarpet.toArray());
                GT_Values.RA.addBoxingRecipe(
                    GT_Utility.copyAmount(1L, new Object[] { aStack }),
                    new ItemStack(Blocks.carpet, costMultiplier, 15),
                    GT_OreDictUnificator.get(correspondingCable, aMaterial, 1L),
                    100,
                    8);
            case "Iron":
        ...
        if (GT_Mod.gregtechproxy.mAE2Integration) {
            ...
            Api.INSTANCE.registries()
                .p2pTunnel()
                .addNewAttunement(GT_OreDictUnificator.get(correspondingCable, aMaterial, 1L), TunnelType.IC2_POWER);
        }
    }
}
