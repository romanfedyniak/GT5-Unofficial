            ...
            if ((tAmount > 0) && (tAmount <= 64) && (aPrefix.mMaterialAmount % 3628800L == 0L)) {
                ...
                if (!OrePrefixes.block.isIgnored(aMaterial.mSmeltInto)) {
                    GT_Values.RA.addExtruderRecipe(
                        ...
                        ItemList.Shape_Extruder_Block.get(0L, new Object[0]),
                ...
                if (((aPrefix != OrePrefixes.ingot) || (aMaterial != aMaterial.mSmeltInto))) {
                    GT_Values.RA.addExtruderRecipe(
                        ...
                        ItemList.Shape_Extruder_Ingot.get(0L, new Object[0]),
                ...
                GT_Values.RA.addExtruderRecipe(
                    GT_Utility.copyAmount(1L, new Object[] { aStack }),
                    ItemList.Shape_Extruder_Pipe_Tiny.get(0L, new Object[0]),
                ...
                if (tAmount * 2 <= 64) GT_Values.RA.addExtruderRecipe(
                    GT_Utility.copyAmount(1L, new Object[] { aStack }),
                    ItemList.Shape_Extruder_Wire.get(0L, new Object[0]),
                ...
                if (tAmount * 8 <= 64) GT_Values.RA.addExtruderRecipe(
                    GT_Utility.copyAmount(1L, new Object[] { aStack }),
                    ItemList.Shape_Extruder_Bolt.get(0L, new Object[0]),
                ...
                if (tAmount * 4 <= 64) {
                    GT_Values.RA.addExtruderRecipe(
                        GT_Utility.copyAmount(1L, new Object[] { aStack }),
                        ItemList.Shape_Extruder_Ring.get(0L, new Object[0]),
                ...
                GT_Values.RA.addExtruderRecipe(
                    GT_Utility.copyAmount(1L, new Object[] { aStack }),
                    ItemList.Shape_Extruder_Gear_Small.get(0L, new Object[0]),
                    GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, aMaterial.mSmeltInto, tAmount),
                    (int) Math.max(aMaterialMass * 0.2 * tAmount, tAmount),
                    (int) (8 * tVoltageMultiplier));
                ...
                GT_Values.RA.addAlloySmelterRecipe(
                    ...
                    ItemList.Shape_Mold_Gear.get(0L, new Object[0]),
                    GT_OreDictUnificator.get(OrePrefixes.gearGt, aMaterial.mSmeltInto, tAmount),
                ...
                switch (aMaterial.mSmeltInto.mName) {
                    case "Glass":
                        GT_Values.RA.addExtruderRecipe(
                            GT_Utility.copyAmount(1L, new Object[] { aStack }),
                            ItemList.Shape_Extruder_Bottle.get(0L, new Object[0]),
                    ...
                    case "Steel":
                        GT_Values.RA.addExtruderRecipe(
                            ...
                            ItemList.Cell_Empty.get(tAmount, new Object[0]),
                            tAmount * 128,
                            32);
                        if (tAmount * 2 <= 64) GT_Values.RA.addExtruderRecipe(
                            GT_Utility.copyAmount(1L, new Object[] { aStack }),
                            ItemList.Shape_Extruder_Casing.get(0L, new Object[0]),
                    ...
                    case "WroughtIron":
                        ...
                        if (tAmount * 31 <= 64) GT_Values.RA.addAlloySmelterRecipe(
                            GT_Utility.copyAmount(31L, new Object[] { aStack }),
