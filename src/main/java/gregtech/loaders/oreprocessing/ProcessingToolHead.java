...
public class ProcessingToolHead implements gregtech.api.interfaces.IOreRecipeRegistrator {
    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName,
        ...
        switch (aPrefix) {
            case toolHeadArrow:
                if (aMaterial.mStandardMoltenFluid != null) GT_Values.RA.addFluidSolidifierRecipe(
            ...
            case toolHeadBuzzSaw:
                GT_ModHandler.addCraftingRecipe(
                    GT_MetaGenerated_Tool_01.INSTANCE.getToolWithStats(
                        GT_MetaGenerated_Tool_01.BUZZSAW,
                        1,
                        aMaterial,
                    ...
                    new Object[] { "PBM", "dXG", "SGP", 'X', aOreDictName, 'M',
                        ItemList.Electric_Motor_LV.get(1L, new Object[0]), 'S',
            ...
            case toolHeadChainsaw:
                GT_ModHandler.addCraftingRecipe(
                    ...
                    GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.DO_NOT_CHECK_FOR_COLLISIONS
                        | GT_ModHandler.RecipeBits.BUFFERED,
                    new Object[] { "SXd", "GMG", "PBP", 'X', aOreDictName, 'M',
                        ItemList.Electric_Motor_LV.get(1L, new Object[0]), 'S',
                        OrePrefixes.screw.get(Materials.StainlessSteel), 'P',
                        OrePrefixes.plate.get(Materials.StainlessSteel), 'G',
                        OrePrefixes.gearGtSmall.get(Materials.StainlessSteel), 'B',
                ...
                GT_ModHandler.addCraftingRecipe(
                    ...
                    GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.DO_NOT_CHECK_FOR_COLLISIONS
                        | GT_ModHandler.RecipeBits.BUFFERED,
                    new Object[] { "SXd", "GMG", "PBP", 'X', aOreDictName, 'M',
                        ItemList.Electric_Motor_MV.get(1L, new Object[0]), 'S',
                        OrePrefixes.screw.get(Materials.Titanium), 'P', OrePrefixes.plate.get(Materials.Titanium), 'G',
                        OrePrefixes.gearGtSmall.get(Materials.Titanium), 'B',
                ...
                GT_ModHandler.addCraftingRecipe(
                    ...
                    GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.DO_NOT_CHECK_FOR_COLLISIONS
                        | GT_ModHandler.RecipeBits.BUFFERED,
                    new Object[] { "SXd", "GMG", "PBP", 'X', aOreDictName, 'M',
                        ItemList.Electric_Motor_HV.get(1L, new Object[0]), 'S',
                        OrePrefixes.screw.get(Materials.TungstenSteel), 'P',
                        OrePrefixes.plate.get(Materials.TungstenSteel), 'G',
                        OrePrefixes.gearGtSmall.get(Materials.TungstenSteel), 'B',
            ...
            case toolHeadDrill:
                ...
                GT_ModHandler.addCraftingRecipe(
                    ...
                    new Object[] { "SXd", "PRP", "MPB", 'X', OrePrefixes.stickLong.get(aMaterial), 'M',
                        ItemList.Electric_Piston_HV.get(1L, new Object[0]), 'S',
                        OrePrefixes.screw.get(Materials.Titanium), 'P', OrePrefixes.plate.get(Materials.Titanium), 'R',
                        OrePrefixes.spring.get(Materials.Titanium), 'B',
                        ItemList.Battery_RE_HV_Lithium.get(1L, new Object[0]) });
                GT_ModHandler.addCraftingRecipe(
                    GT_MetaGenerated_Tool_01.INSTANCE.getToolWithStats(
                        GT_MetaGenerated_Tool_01.JACKHAMMER,
                    ...
                    GT_ModHandler.addShapelessCraftingRecipe(
                        GT_MetaGenerated_Tool_01.INSTANCE.getToolWithStats(
                            (aMaterial.contains(SubTag.BOUNCY)) || (aMaterial.contains(SubTag.WOOD))
                                ? GT_MetaGenerated_Tool_01.SOFTHAMMER
