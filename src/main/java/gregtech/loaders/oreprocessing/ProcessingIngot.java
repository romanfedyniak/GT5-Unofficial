    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName,
        ...
        switch (aPrefix) {
            case ingot:
                ...
                if (!aNoSmashing) {
                    // GT_Values.RA.addWiremillRecipe(GT_Utility.copyAmount(1L, new Object[]{aStack}),
                    // GT_Utility.copy(new Object[]{GT_OreDictUnificator.get(OrePrefixes.wireGt01, aMaterial, 2L),
                    // GT_OreDictUnificator.get(OrePrefixes.wireFine, aMaterial, 8L)}), 100, 4);
                    // GT_Values.RA.addWiremillRecipe(GT_Utility.copyAmount(1L, new Object[]{aStack}),
                    // GT_OreDictUnificator.get(OrePrefixes.wireGt01, aMaterial, 2L), 100, 4);
                ...
                if (!aNoSmashing) {
                    ...
                    if (aSpecialRecipeReq && GregTech_API.sRecipeFile
                        ...
                        GT_ModHandler.addCraftingRecipe(
                            ...
                            GT_Proxy.tBits,
                            new Object[] { "I", "I", "h", Character.valueOf('I'), OrePrefixes.ingot.get(aMaterial) });
                    }
                }
                break;
            case ingotTriple:
                if (!aNoSmashing) {
                    ...
                    if (aSpecialRecipeReq && GregTech_API.sRecipeFile
                        ...
                        GT_ModHandler.addCraftingRecipe(
                            ...
                            GT_Proxy.tBits,
                            new Object[] { "I", "B", "h", Character.valueOf('I'),
                                OrePrefixes.ingotDouble.get(aMaterial), Character.valueOf('B'),
                ...
                if (!aNoSmashing) {
                    ...
                    if (aSpecialRecipeReq && GregTech_API.sRecipeFile
                        ...
                        GT_ModHandler.addCraftingRecipe(
                            ...
                            GT_Proxy.tBits,
                            new Object[] { "I", "B", "h", Character.valueOf('I'),
                                OrePrefixes.ingotTriple.get(aMaterial), Character.valueOf('B'),
                                OrePrefixes.ingot.get(aMaterial) });
                    }
                }
                break;
                ...
                if (!aNoSmashing) {
                    ...
                    if (aSpecialRecipeReq && GregTech_API.sRecipeFile
                        ...
                        GT_ModHandler.addCraftingRecipe(
                            ...
                            GT_Proxy.tBits,
                            new Object[] { "I", "B", "h", Character.valueOf('I'),
                                OrePrefixes.ingotQuadruple.get(aMaterial), Character.valueOf('B'),
                                OrePrefixes.ingot.get(aMaterial) });
                    }
                }
                break;
