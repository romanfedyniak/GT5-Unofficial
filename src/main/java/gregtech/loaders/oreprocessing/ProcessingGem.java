    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName,
        ...
        switch (aPrefix) {
            case gem:
                ...
                gregtech.api.util.GT_RecipeRegistrator.registerUsagesForMaterials(
                    GT_Utility.copyAmount(1L, new Object[] { aStack }),
                    ...
                    case "Charcoal":
                        if (gregtech.api.GregTech_API.sRecipeFile.get(
                            ...
                            GT_ModHandler.removeRecipe(
                                new ItemStack[] { GT_Utility.copyAmount(1L, new Object[] { aStack }), null, null,
            ...
            case gemExquisite:
                if (aFuelPower) GT_Values.RA.addFuel(
                    ...
                    aMaterial.mFuelType);
                if (!aNoWorking) {
                    // GT_Values.RA.addLatheRecipe(GT_Utility.copyAmount(1L, new Object[]{aStack}),
                    // GT_OreDictUnificator.get(OrePrefixes.stickLong, aMaterial, 3L),
                    // GT_OreDictUnificator.getDust(aMaterial, aPrefix.mMaterialAmount -
                    // OrePrefixes.stickLong.mMaterialAmount * 3L), (int) Math.max(aMaterialMass * 10L, 1L), 16);
                    if (aMaterial.mUnificatable && (aMaterial.mMaterialInto == aMaterial))
                        if (aSpecialRecipeReq) GT_ModHandler.addCraftingRecipe(
