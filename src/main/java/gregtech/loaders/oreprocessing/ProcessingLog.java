...
public class ProcessingLog implements gregtech.api.interfaces.IOreRecipeRegistrator {
    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName,
        ...
        GT_ModHandler.addCraftingRecipe(
            ...
            new Object[] { "sLf", 'L', GT_Utility.copyAmount(1L, new Object[] { aStack }) });
        ...
        if (aMeta == Short.MAX_VALUE) {
            if ((GT_Utility.areStacksEqual(
                GT_ModHandler.getSmeltingOutput(GT_Utility.copyAmount(1L, new Object[] { aStack }), false, null),
            ...
            for (int i = 0; i < 32767; i++) {
                ...
                ItemStack tStack = GT_ModHandler
                    .getRecipeOutput(new ItemStack[] { new ItemStack(aStack.getItem(), 1, i) });
                if (tStack == null) {
                    if (i >= 16) {
                        break;
                    }
            ...
            ItemStack tStack = GT_ModHandler
                .getRecipeOutput(new ItemStack[] { GT_Utility.copyAmount(1L, new Object[] { aStack }) });
            if (tStack != null) {
                ItemStack tPlanks = GT_Utility.copy(new Object[] { tStack });
                tPlanks.stackSize = (tPlanks.stackSize * 3 / 2);
                GT_Values.RA.addCutterRecipe(
                ...
                GT_ModHandler.addCraftingRecipe(
                    GT_Utility.copyAmount(
                        GT_Mod.gregtechproxy.mNerfedWoodPlank ? tStack.stackSize : tStack.stackSize * 5 / 4,
                        new Object[] { tStack }),
                    new Object[] { "s", "L", 'L', GT_Utility.copyAmount(1L, new Object[] { aStack }) });
                GT_ModHandler.addShapelessCraftingRecipe(
                    GT_Utility.copyAmount(
                        tStack.stackSize / (GT_Mod.gregtechproxy.mNerfedWoodPlank ? 2 : 1),
                        new Object[] { tStack }),
    ...
    public void addPyrolyeOvenRecipes(ItemStack logStack) {
        GT_Values.RA.addPyrolyseRecipe(
            GT_Utility.copyAmount(16L, new Object[] { logStack }),
            GT_Values.NF,
            1,
