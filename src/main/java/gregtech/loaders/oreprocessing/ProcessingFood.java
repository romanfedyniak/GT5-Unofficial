        ...
        switch (aOreDictName) {
            case "foodCheese":
                GT_Values.RA.addSlicerRecipe(
                    ...
                    ItemList.Food_Sliced_Cheese.get(4L, new Object[0]),
                    64,
                    4);
                GT_OreDictUnificator.addItemData(
                    aStack,
                    new gregtech.api.objects.ItemData(Materials.Cheese, 3628800L, new MaterialStack[0]));
                break;
            case "foodDough":
                ...
                GT_Values.RA.addMixerRecipe(
                    ...
                    null,
                    null,
                    ItemList.Food_Dough_Sugar.get(2L, new Object[0]),
                    32,
                    8);
                GT_Values.RA.addMixerRecipe(
                    aStack,
                    ...
                    null,
                    null,
                    ItemList.Food_Dough_Chocolate.get(2L, new Object[0]),
                    32,
                    8);
                GT_Values.RA.addMixerRecipe(
                    aStack,
