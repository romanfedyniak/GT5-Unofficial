...
public class GT_CropLoader implements Runnable {
    ...
    public void run() {
        ...
        try {
            ItemStack[] tI = new ItemStack[] { ItemList.Crop_Drop_Indigo.get(4L, new Object[0]),
                ItemList.Crop_Drop_MilkWart.get(4L, new Object[0]), new ItemStack(Blocks.brown_mushroom, 4),
            ...
            new GT_BaseCrop(
                ...
                0,
                1,
                new String[] { "Silk", "Vine", "Addictive" },
            ...
            new GT_BaseCrop(
                ...
                new ItemStack[] { ItemList.Dye_Bonemeal.get(1L, new Object[0]),
                    ItemList.Dye_Bonemeal.get(1L, new Object[0]), new ItemStack(Items.bone, 1) });
            new GT_BaseCrop(
                134,
                "Creeperweed",
                "General Spaz",
            ...
            new GT_BaseCrop(
                ...
                3,
                0,
                new String[] { "Edible", "Flower", "Cow", "Fish", "Chicken", "Pig" },
            ...
            new GT_BaseCrop(
                ...
                0,
                2,
                new String[] { "Edible", "Mushroom", "Ingredient" },
            ...
            new GT_BaseCrop(
                ...
                new ItemStack[] { ItemList.IC2_Plantball.get(1, new Object[0]),
                    ItemList.IC2_Scrap.get(1, new Object[0]),
            ...
            new GT_BaseCrop(
                ...
                Materials.Lapis,
                GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Lapis, 1L),
                null);
            new GT_BaseCrop(
                151,
                "Glowheat",
                ...
                GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Glowstone, 1L),
                null);
            new GT_BaseCrop(
                153,
                "Fertilia",
                ...
                GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Calcite, 1L),
                new ItemStack[] { ItemList.IC2_Fertilizer.get(1, new Object[0]),
                    GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Apatite, 1L),
            ...
            new GT_BaseCrop(
                ...
                new ItemStack[] { ItemList.Crop_Drop_Uraninite.get(1, new Object[0]) });
            new GT_BaseCrop(
                157,
                "God of Thunder",
                "unknown",
                ...
                Materials.Thorium,
                GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Coal, 1L),
            ...
            new GT_BaseCrop(
                ...
                new ItemStack[] { ItemList.Crop_Drop_UUABerry.get(1L, new Object[0]),
                    ItemList.Crop_Drop_UUABerry.get(1L, new Object[0]),
                    ItemList.Crop_Drop_UUABerry.get(1L, new Object[0]),
                    ItemList.Crop_Drop_UUABerry.get(1L, new Object[0]),
            ...
            new GT_BaseCrop(
                ...
                new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Coal, 1L),
                    ...
                    GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.NetherStar, 1L) });
            new GT_BaseCrop(
                160,
                "Zomplant",
                "unknown",
            ...
            new GT_BaseCrop(
                ...
                GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.NetherQuartz, 1L),
                new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.gem, Materials.NetherQuartz, 1L),
                    GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.CertusQuartz, 1L), });
            new GT_BaseCrop(
                164,
                "Olivia",
                "unknown",
                ...
                Materials.Olivine,
                GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Olivine, 1L),
            ...
            new GT_BaseCrop(
                ...
                new ItemStack[] { ItemList.Crop_Drop_Osmium.get(1, new Object[0]) });
            new GT_BaseCrop(
                170,
                "Stargatium",
                "unknown",
                ...
                Materials.Naquadah,
                GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Endstone, 1L),
                new ItemStack[] { ItemList.Crop_Drop_Naquadah.get(1, new Object[0]) });
            new GT_BaseCrop(
                171,
                "Lemon",
                "unknown",
                ...
                2,
                0,
                new String[] { "Food", "Tree", "Sour" },
                ItemList.Crop_Drop_Lemon.get(1, new Object[0]),
                null);
            new GT_BaseCrop(
                172,
                "Chilly",
                ...
                2,
                0,
                new String[] { "Food", "Spicy" },
                ItemList.Crop_Drop_Chilly.get(1, new Object[0]),
                null);
            new GT_BaseCrop(
                173,
                "Tomato",
                ...
                0,
                new String[] { "Food" },
                ItemList.Crop_Drop_Tomato.get(1, new Object[0]),
                new ItemStack[] { ItemList.Crop_Drop_MTomato.get(1, new Object[0]) });
            new GT_BaseCrop(
                174,
                "Grape",
                "unknown",
                ...
                0,
                new String[] { "Food" },
                ItemList.Crop_Drop_Grapes.get(1, new Object[0]),
                null);
            new GT_BaseCrop(
                175,
                "Onion",
                ...
                0,
                new String[] { "Food" },
                ItemList.Crop_Drop_Onion.get(1, new Object[0]),
                null);
            new GT_BaseCrop(
                176,
                "Cucumber",
                ...
                0,
                new String[] { "Food" },
                ItemList.Crop_Drop_Cucumber.get(1, new Object[0]),
                null);
            new GT_BaseCrop(
                177,
                "Tea",
                ...
                0,
                new String[] { "Food" },
                ItemList.Crop_Drop_TeaLeaf.get(1, new Object[0]),
                null);
            new GT_BaseCrop(
                178,
                "Rape",
