...
public class GT_BookAndLootLoader implements Runnable {
    ...
    public void run() {
        ...
        ChestGenHooks.addItem(
            "bonusChest",
            new WeightedRandomChestContent(ItemList.Bottle_Purple_Drink.get(1L, new Object[0]), 8, 16, 2));

        ChestGenHooks.addItem(
            "dungeonChest",
            new WeightedRandomChestContent(ItemList.Bottle_Holy_Water.get(1L, new Object[0]), 4, 8, 20));
        ChestGenHooks.addItem(
            "dungeonChest",
            new WeightedRandomChestContent(ItemList.Bottle_Purple_Drink.get(1L, new Object[0]), 8, 16, 80));
        ChestGenHooks.addItem(
            "dungeonChest",
        ...
        ChestGenHooks.addItem(
            "pyramidDesertyChest",
            new WeightedRandomChestContent(ItemList.Bottle_Holy_Water.get(1L, new Object[0]), 4, 8, 2));
        ChestGenHooks.addItem(
            "pyramidDesertyChest",
            new WeightedRandomChestContent(
                GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Silver, 1L),
        ...
        ChestGenHooks.addItem(
            "pyramidJungleChest",
            new WeightedRandomChestContent(ItemList.Coin_Gold_Ancient.get(1L, new Object[0]), 16, 64, 10));
        ChestGenHooks.addItem(
            "pyramidJungleChest",
            new WeightedRandomChestContent(ItemList.ZPM.getWithCharge(1L, 2147483647, new Object[0]), 1, 1, 1));
        ChestGenHooks.addItem(
            "pyramidJungleChest",
            new WeightedRandomChestContent(
                GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Bronze, 1L),
