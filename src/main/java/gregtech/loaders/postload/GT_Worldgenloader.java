...
public class GT_Worldgenloader implements Runnable {
    ...
    public void run() {
        boolean tPFAA = (GregTech_API.sWorldgenFile.get(ConfigCategories.general, "AutoDetectPFAA", true))
            && (Loader.isModLoaded("PFAAGeologica"));
        ...
        if (GregTech_API.mImmersiveEngineering && GT_Mod.gregtechproxy.mImmersiveEngineeringRecipes
            && mSupportIE != null) {
            try {
                mSupportIE.getDeclaredMethod("recalculateChances", boolean.class)
                    .invoke(null, true);
