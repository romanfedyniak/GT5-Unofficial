...
public class GT_Loader_ItemData implements Runnable {
    ...
    public void run() {
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(Materials.Knightmetal, 403200L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            GT_ModHandler.getModItem("TwilightForest", "item.shardCluster", 1L, 0),
            new ItemData(Materials.Knightmetal, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            ItemList.TF_LiveRoot.get(1L, new Object[0]),
            new ItemData(Materials.LiveRoot, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(Materials.NetherQuartz, 1814400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 12),
            new ItemData(Materials.Fluix, 1814400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.quartz_block, 1, 32767),
            new ItemData(Materials.NetherQuartz, 14515200L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockQuartz", 1L, 32767),
            new ItemData(Materials.CertusQuartz, 14515200L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(Materials.Wheat, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.hay_block, 1, 32767),
            new ItemData(Materials.Wheat, 32659200L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Items.snowball, 1, 32767),
            new ItemData(Materials.Snow, 907200L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.snow, 1, 32767),
            new ItemData(Materials.Snow, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.glowstone, 1, 32767),
            new ItemData(Materials.Glowstone, 14515200L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.redstone_lamp, 1, 32767),
            new ItemData(
                Materials.Glowstone,
                14515200L,
                new MaterialStack[] { new MaterialStack(Materials.Redstone, OrePrefixes.dust.mMaterialAmount * 4L) }));
        GT_OreDictUnificator.addItemData(
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(Materials.Ice, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.ice, 1, 32767),
            new ItemData(Materials.Ice, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.packed_ice, 1, 32767),
            new ItemData(Materials.Ice, 7257600L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Items.clay_ball, 1, 32767),
            new ItemData(Materials.Clay, 1814400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.clay, 1, 32767),
            new ItemData(Materials.Clay, 7257600L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.hardened_clay, 1, 32767),
            new ItemData(Materials.Clay, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.stained_hardened_clay, 1, 32767),
            new ItemData(Materials.Clay, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.brick_block, 1, 32767),
            new ItemData(Materials.Brick, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            GT_ModHandler.getIC2Item("Uran238", 1L),
            new ItemData(Materials.Uranium, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            GT_ModHandler.getIC2Item("Uran235", 1L),
            new ItemData(Materials.Uranium235, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            GT_ModHandler.getIC2Item("Plutonium", 1L),
            new ItemData(Materials.Plutonium, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            GT_ModHandler.getIC2Item("smallUran235", 1L),
            new ItemData(Materials.Uranium235, 403200L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            GT_ModHandler.getIC2Item("smallPlutonium", 1L),
            new ItemData(Materials.Plutonium, 403200L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            ItemList.IC2_Item_Casing_Iron.get(1L, new Object[0]),
            new ItemData(Materials.Iron, 1814400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            ItemList.IC2_Item_Casing_Gold.get(1L, new Object[0]),
            new ItemData(Materials.Gold, 1814400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            ItemList.IC2_Item_Casing_Bronze.get(1L, new Object[0]),
            new ItemData(Materials.Bronze, 1814400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            ItemList.IC2_Item_Casing_Copper.get(1L, new Object[0]),
            new ItemData(Materials.Copper, 1814400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            ItemList.IC2_Item_Casing_Tin.get(1L, new Object[0]),
            new ItemData(Materials.Tin, 1814400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            ItemList.IC2_Item_Casing_Lead.get(1L, new Object[0]),
            new ItemData(Materials.Lead, 1814400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            ItemList.IC2_Item_Casing_Steel.get(1L, new Object[0]),
            new ItemData(Materials.Steel, 1814400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Items.book, 1, 32767),
            new ItemData(Materials.Paper, 10886400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(Materials.Gold, OrePrefixes.block.mMaterialAmount * 8L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Items.golden_apple, 1, 0),
            new ItemData(Materials.Gold, OrePrefixes.ingot.mMaterialAmount * 8L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Items.golden_carrot, 1, 0),
            new ItemData(Materials.Gold, OrePrefixes.nugget.mMaterialAmount * 8L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Items.speckled_melon, 1, 0),
            new ItemData(Materials.Gold, OrePrefixes.nugget.mMaterialAmount * 8L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Items.minecart, 1),
            new ItemData(Materials.Iron, 18144000L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Items.cauldron, 1),
            new ItemData(Materials.Iron, 25401600L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.iron_bars, 8, 32767),
            new ItemData(Materials.Iron, 10886400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(Materials.Tin, 1814400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            ItemList.IC2_Fuel_Rod_Empty.get(1L, new Object[0]),
            new ItemData(Materials.Iron, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            ItemList.IC2_Fuel_Can_Empty.get(1L, new Object[0]),
            new ItemData(Materials.Tin, 25401600L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.light_weighted_pressure_plate, 1, 32767),
            new ItemData(Materials.Gold, 7257600L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.heavy_weighted_pressure_plate, 1, 32767),
            new ItemData(Materials.Iron, 7257600L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            GT_ModHandler.getModItem("Railcraft", "tile.railcraft.anvil", 1L, 0),
            new ItemData(Materials.Steel, 108864000L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            GT_ModHandler.getModItem("Railcraft", "tile.railcraft.anvil", 1L, 1),
            new ItemData(Materials.Steel, 72576000L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            GT_ModHandler.getModItem("Railcraft", "tile.railcraft.anvil", 1L, 2),
            new ItemData(Materials.Steel, 36288000L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.anvil, 1, 0),
            new ItemData(Materials.Iron, 108864000L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.anvil, 1, 1),
            new ItemData(Materials.Iron, 72576000L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.anvil, 1, 2),
            new ItemData(Materials.Iron, 36288000L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.hopper, 1, 32767),
            new ItemData(
                Materials.Iron,
                18144000L,
                new MaterialStack[] { new MaterialStack(Materials.Wood, 29030400L) }));
        GT_OreDictUnificator.addItemData(
            ItemList.Cell_Universal_Fluid.get(1L, new Object[0]),
            new ItemData(
                Materials.Tin,
                7257600L,
                new MaterialStack[] { new MaterialStack(Materials.Glass, 1360800L) }));
        GT_OreDictUnificator.addItemData(
            ItemList.Cell_Empty.get(1L, new Object[0]),
            new ItemData(Materials.Tin, 7257600L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.tripwire_hook, 1, 32767),
            new ItemData(
                Materials.Iron,
                OrePrefixes.ring.mMaterialAmount * 2L,
                new MaterialStack[] { new MaterialStack(Materials.Wood, 3628800L) }));
        GT_OreDictUnificator.addItemData(
            ItemList.Bottle_Empty.get(1L, new Object[0]),
            new ItemData(Materials.Glass, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(Materials.Glass, 1360800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(
                Materials.Iron,
                29030400L,
                new MaterialStack[] { new MaterialStack(Materials.Leather, 21772800L) }));
        GT_OreDictUnificator.addItemData(
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(Materials.Leather, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.beacon, 1, 32767),
            new ItemData(
                Materials.NetherStar,
                3628800L,
                new MaterialStack[] { new MaterialStack(Materials.Obsidian, 10886400L),
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(
                Materials.Diamond,
                7257600L,
                new MaterialStack[] { new MaterialStack(Materials.Obsidian, 14515200L),
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(
                Materials.EnderEye,
                3628800L,
                new MaterialStack[] { new MaterialStack(Materials.Obsidian, 29030400L) }));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.bookshelf, 1, 32767),
            new ItemData(
                Materials.Paper,
                32659200L,
                new MaterialStack[] { new MaterialStack(Materials.Wood, 21772800L) }));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.lever, 1, 32767),
            new ItemData(
                Materials.Stone,
                3628800L,
                new MaterialStack[] { new MaterialStack(Materials.Wood, 1814400L) }));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.ice, 1, 32767),
            new ItemData(Materials.Ice, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(Materials.Snow, -1L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.sand, 1, 32767),
            new ItemData(Materials.Sand, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.sandstone, 1, 32767),
            new ItemData(Materials.Sand, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.stone_slab, 1, 0),
            new ItemData(Materials.Stone, 1814400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.stone_slab, 1, 8),
            new ItemData(Materials.Stone, 1814400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.double_stone_slab, 1, 0),
            new ItemData(Materials.Stone, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.double_stone_slab, 1, 8),
            new ItemData(Materials.Stone, 3628800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.stone_slab, 1, 1),
            new ItemData(Materials.Sand, 1814400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(Materials.Stone, 29030400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(Materials.Stone, 7257600L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(Materials.Wood, 7257600L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.fence, 1, 32767),
            new ItemData(Materials.Wood, 5443200L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(Materials.Wood, 29030400L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.trapped_chest, 1, 32767),
            new ItemData(
                Materials.Wood,
                32659200L,
                new MaterialStack[] { new MaterialStack(Materials.Iron, OrePrefixes.ring.mMaterialAmount * 2L) }));
        GT_OreDictUnificator.addItemData(
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(
                Materials.Wood,
                29030400L,
                new MaterialStack[] { new MaterialStack(Materials.Diamond, 3628800L) }));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.crafting_table, 1, 32767),
            new ItemData(Materials.Wood, 14515200L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Blocks.piston, 1, 32767),
            new ItemData(
                Materials.Stone,
                14515200L,
                new MaterialStack[] { new MaterialStack(Materials.Wood, 10886400L) }));
        GT_OreDictUnificator.addItemData(
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(Materials.MeatCooked, 403200L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
