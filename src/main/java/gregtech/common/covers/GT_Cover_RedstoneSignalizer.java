...
public class GT_Cover_RedstoneSignalizer extends GT_CoverBehavior {
    ...
    public int onCoverScrewdriverclick(byte aSide, int aCoverID, int aCoverVariable, ICoverable aTileEntity,
        ...
        switch (aCoverVariable / 16) {
            case 0:
                GT_Utility.sendChatToPlayer(aPlayer, trans("078", "Signal = ") + (aCoverVariable & 0xF));
                break;
            case 1:
                GT_Utility.sendChatToPlayer(aPlayer, trans("079", "Conditional Signal = ") + (aCoverVariable & 0xF));
                break;
            case 2:
                GT_Utility
                    .sendChatToPlayer(aPlayer, trans("080", "Inverted Conditional Signal = ") + (aCoverVariable & 0xF));
                break;
        }
