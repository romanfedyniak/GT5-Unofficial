...
public class GT_Container_TypeFilter extends GT_ContainerMetaTile_Machine {
    ...
    public ItemStack slotClick(int aSlotIndex, int aMouseclick, int aShifthold, EntityPlayer aPlayer) {
        ...
        if (tSlot != null) {
            ...
            if (aSlotIndex == 10) {
                ((GT_MetaTileEntity_TypeFilter) this.mTileEntity
                    .getMetaTileEntity()).bOutput = (!((GT_MetaTileEntity_TypeFilter) this.mTileEntity
            ...
            if (aSlotIndex == 11) {
                ((GT_MetaTileEntity_TypeFilter) this.mTileEntity
                    .getMetaTileEntity()).bRedstoneIfFull = (!((GT_MetaTileEntity_TypeFilter) this.mTileEntity
            ...
            if (aSlotIndex == 12) {
                ((GT_MetaTileEntity_TypeFilter) this.mTileEntity
                    .getMetaTileEntity()).bInvert = (!((GT_MetaTileEntity_TypeFilter) this.mTileEntity
            ...
            if (aSlotIndex == 13) {
                ((GT_MetaTileEntity_TypeFilter) this.mTileEntity
                    .getMetaTileEntity()).bInvertFilter = (!((GT_MetaTileEntity_TypeFilter) this.mTileEntity
                        .getMetaTileEntity()).bInvertFilter);
            ...
            if (aSlotIndex == 14) {
                ((GT_MetaTileEntity_TypeFilter) this.mTileEntity
                    .getMetaTileEntity()).bNBTAllowed = (!((GT_MetaTileEntity_TypeFilter) this.mTileEntity
                        .getMetaTileEntity()).bNBTAllowed);
