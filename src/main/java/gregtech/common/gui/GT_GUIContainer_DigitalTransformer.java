...
public class GT_GUIContainer_DigitalTransformer extends GT_GUIContainerMetaTile_Machine {
    ...
    public GT_GUIContainer_DigitalTransformer(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity) {
        super(
            new GT_Container_DigitalTransformer(aInventoryPlayer, aTileEntity),
            RES_PATH_GUI + "DigitalTransformer.png");
    }
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        fontRendererObj.drawString(
            "V: " + VN[((GT_MetaTileEntity_Transformer) dpg.mTileEntity.getMetaTileEntity()).mTier]
                + " ("
                + formatNumbers(V[((GT_MetaTileEntity_Transformer) dpg.mTileEntity.getMetaTileEntity()).mTier])
                + ")",
            36,
            9,
            16448255);
        ...
        fontRendererObj
            .drawString("V: " + VN[dpg.oTier] + " (" + formatNumbers(V[dpg.oTier]) + ")", 36, 9 + 36, 16448255);
