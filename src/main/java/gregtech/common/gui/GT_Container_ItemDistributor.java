...
public class GT_Container_ItemDistributor extends GT_ContainerMetaTile_Machine {
    ...
    public ItemStack slotClick(int aSlotIndex, int aMouseclick, int aShifthold, EntityPlayer aPlayer) {
        ...
        if (tSlot != null) {
            ...
            if (aSlotIndex == 27) {
                ((GT_MetaTileEntity_ItemDistributor) this.mTileEntity
                    .getMetaTileEntity()).bOutput = (!((GT_MetaTileEntity_ItemDistributor) this.mTileEntity
            ...
            if (aSlotIndex == 28) {
                ((GT_MetaTileEntity_ItemDistributor) this.mTileEntity
                    .getMetaTileEntity()).bRedstoneIfFull = (!((GT_MetaTileEntity_ItemDistributor) this.mTileEntity
            ...
            if (aSlotIndex == 29) {
                ((GT_MetaTileEntity_ItemDistributor) this.mTileEntity
                    .getMetaTileEntity()).bInvert = (!((GT_MetaTileEntity_ItemDistributor) this.mTileEntity
