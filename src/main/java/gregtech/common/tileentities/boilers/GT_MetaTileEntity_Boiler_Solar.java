...
public class GT_MetaTileEntity_Boiler_Solar extends GT_MetaTileEntity_Boiler {
    ...
    public GT_MetaTileEntity_Boiler_Solar(int aID, String aName, String aNameRegional) {
        super(
            ...
            aName,
            aNameRegional,
            new String[] { "Steam Power by the Sun", "Produces 120L of Steam per second",
                "Calcifies over time, reducing Steam output to 40L/s", "Break and replace to decalcify" });
    }
    ...
    public ITexture[][][] getTextureSet(ITexture[] aTextures) {
        ...
        for (byte i = -1; i < 16; i = (byte) (i + 1)) {
            ...
            ITexture[] tmp2 = { new GT_RenderedTexture(
        ...
        if ((aBaseMetaTileEntity.isServerSide()) && (aTick > 20L)) {
            ...
            if ((this.mProcessingEnergy <= 0) && (aBaseMetaTileEntity.isAllowedToWork())
                ...
                && (!aBaseMetaTileEntity.getWorld()
                    .isThundering())) {
                boolean bRain = aBaseMetaTileEntity.getWorld()
                    .isRaining() && aBaseMetaTileEntity.getBiome().rainfall > 0.0F;
                mProcessingEnergy += bRain && aBaseMetaTileEntity.getWorld().skylightSubtracted >= 4
