...
public class GT_MetaTileEntity_Digital_Transformer extends GT_MetaTileEntity_Transformer {
    ...
    public GT_MetaTileEntity_Digital_Transformer(int aID, String aName, String aNameRegional, int aTier,
        String aDescription) {
        super(aID, aName, aNameRegional, aTier, aDescription);
    }

    public GT_MetaTileEntity_Digital_Transformer(String aName, int aTier, String aDescription,
        ITexture[][][] aTextures) {
    ...
    public ITexture[][][] getTextureSet(ITexture[] aTextures) {
        ...
        for (byte i = -1; i < 16; i++) {
            rTextures[0][i + 1] = new ITexture[] {
                new GT_RenderedTexture(Textures.BlockIcons.DIGITAL_TRANSFORMER[mTier]),
