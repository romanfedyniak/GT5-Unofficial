...
public class GT_MetaTileEntity_BrickedBlastFurnace extends GT_MetaTileEntity_PrimitiveBlastFurnace {
    ...
    private static final ITexture[] FACING_SIDE = {
        new GT_RenderedTexture(Textures.BlockIcons.MACHINE_CASING_DENSEBRICKS) };
    private static final ITexture[] FACING_FRONT = {
        new GT_RenderedTexture(Textures.BlockIcons.MACHINE_CASING_BRICKEDBLASTFURNACE_INACTIVE) };
    ...
    public String[] getDescription() {
        return new String[] { "Controller Block for the Bricked Blast Furnace",
            "Useable for Steel and general Pyrometallurgy", "Size(WxHxD): 3x4x3 (Hollow, with opening on top)",
            "Built from 32 Firebrick blocks", "Causes 50 Pollution per second" };
    }
