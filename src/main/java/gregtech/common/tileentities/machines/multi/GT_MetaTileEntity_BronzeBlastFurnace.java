...
public class GT_MetaTileEntity_BronzeBlastFurnace extends GT_MetaTileEntity_PrimitiveBlastFurnace {
    ...
    private static final ITexture[] FACING_SIDE = {
        new GT_RenderedTexture(Textures.BlockIcons.MACHINE_BRONZEPLATEDBRICKS) };
    private static final ITexture[] FACING_FRONT = {
        new GT_RenderedTexture(Textures.BlockIcons.MACHINE_BRONZEBLASTFURNACE) };
    ...
    public String[] getDescription() {
        return new String[] { "Controller Block for the Bronze Blast Furnace",
            "Useable for Steel and general Pyrometallurgy", "Size(WxHxD): 3x4x3 (Hollow, with opening on top)",
            "Built from 32 Bronze Plated Bricks", "Causes 50 Pollution per second" };
    }
