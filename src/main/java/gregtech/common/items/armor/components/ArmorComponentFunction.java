...
public class ArmorComponentFunction extends ArmorComponent {
    ...
    public ArmorComponentFunction(String aName, ItemStack aStack, boolean aElectric, float aWeight, StatType aType,
        float aProcessingUsed) {
        ...
        mStat.put(
            ...
            (float) GregTech_API.sModularArmor.get(mConfigName, "ProcessingUsed", aProcessingUsed));
    }
