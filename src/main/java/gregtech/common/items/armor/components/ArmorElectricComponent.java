...
public class ArmorElectricComponent extends ArmorComponent {
    ...
    public ArmorElectricComponent(String aName, ItemStack aStack, float aWeight, StatType aType1, float aValue1,
        StatType aType2, float aValue2, StatType aType3, float aValue3) {
        ...
        String tType2 = GregTech_API.sModularArmor
            .get(mConfigName, "StatType", aType2 == null ? "null" : aType2.toString());
        mType2 = tType2.equals("null") ? null : StatType.valueOf(tType2);
        String tType3 = GregTech_API.sModularArmor
            .get(mConfigName, "StatType", aType3 == null ? "null" : aType3.toString());
