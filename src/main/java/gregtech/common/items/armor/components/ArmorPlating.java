...
public class ArmorPlating extends ArmorComponent {
    ...
    public ArmorPlating(String aName, ItemStack aStack, float aWeight, float aPhysicalDef, float aProjectileDef,
        float aFireDef, float aMagicDef, float aExplosionDef, float aFallDef, float aRadiationDef, float aElectricDef,
        float aWitherDef) {
    ...
    public ArmorPlating(String aName, String aOreDict, float aWeight, float aPhysicalDef, float aProjectileDef,
        float aFireDef, float aMagicDef, float aExplosionDef, float aFallDef, float aRadiationDef, float aElectricDef,
        float aWitherDef) {
    ...
    public ArmorPlating(String aName, String aOreDict, float aWeight, float aPhysicalDef, float aProjectileDef,
        float aFireDef, float aMagicDef, float aExplosionDef, float aFallDef, float aRadiationDef, float aElectricDef,
        float aWitherDef, StatType aType, float aSpecial) {
        super(aName, aOreDict, false, aWeight);
        aPhysicalDef = (float) GregTech_API.sModularArmor.get(mConfigName, "PhysicalDef", aPhysicalDef);
        aProjectileDef = (float) GregTech_API.sModularArmor.get(mConfigName, "ProjectileDef", aProjectileDef);
        aFireDef = (float) GregTech_API.sModularArmor.get(mConfigName, "FireDef", aFireDef);
    ...
    public ArmorPlating(String aName, String aOreDict, float aWeight, float aPhysicalDef, float aProjectileDef,
        float aFireDef, float aMagicDef, float aExplosionDef) {
        super(aName, aOreDict, false, aWeight);
        aPhysicalDef = (float) GregTech_API.sModularArmor.get(mConfigName, "PhysicalDef", aPhysicalDef);
        aProjectileDef = (float) GregTech_API.sModularArmor.get(mConfigName, "ProjectileDef", aProjectileDef);
        aFireDef = (float) GregTech_API.sModularArmor.get(mConfigName, "FireDef", aFireDef);
    ...
    public void addStats(float aPhysicalDef, float aProjectileDef, float aFireDef, float aMagicDef, float aExplosionDef,
        float aFallDef, float aRadiationDef, float aElectricDef, float aWitherDef) {
