...
public class GuiModularArmor extends GuiContainer {
    ...
    protected void drawTooltip(int x, int y) {
        ...
        if (x >= 10 && x <= 17) {
            if (y >= 20 && y <= 27) {
                list.add(
                    GT_LanguageManager.getTranslation("Weight") + ": "
                ...
                list.add(
                    GT_LanguageManager.getTranslation("Magic Defence") + ": "
    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        ...
        this.mc.getTextureManager()
            .bindTexture(new ResourceLocation("gregtech", "textures/gui/armorgui3x3.png"));
        int xStart = (width - xSize) / 2;
        int yStart = (height - ySize) / 2;
    ...
    public float getF(StatType aType) {
        if (cont.mInvArmor.data.mStat.containsKey(aType)) return cont.mInvArmor.data.mStat.get(aType);
        return .0f;
    }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseBtn) {
        ...
        if (yStart > 67 && yStart < 77) {
            if (xStart > 124 && xStart < 163) {
                if (xStart > 124 && xStart < 133 && cont.mInvArmor.data.helmet != null) {
                    cont.mInvArmor.data.helmet.openGui = true;
                }
                if (xStart > 134 && xStart < 143 && cont.mInvArmor.data.chestplate != null) {
                    cont.mInvArmor.data.chestplate.openGui = true;
                }
                if (xStart > 144 && xStart < 153 && cont.mInvArmor.data.leggings != null) {
                    cont.mInvArmor.data.leggings.openGui = true;
                }
                if (xStart > 154 && xStart < 163 && cont.mInvArmor.data.boots != null) {
