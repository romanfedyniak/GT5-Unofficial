...
public class GT_MetaGenerated_Item_03 extends GT_MetaGenerated_Item_X32 {
    ...
    public GT_MetaGenerated_Item_03() {
        ...
        // o));
        // ItemList.Circuit_Board_Multifiberglass.set(addItem(tLastID = 5, "Multilayer Fiberglass Circuit Board", "A
        // elite Board", o));
         ...
         * Glass Fibers
         */
        // ItemList.Circuit_Parts_Resistor.set(addItem(tLastID = 10, "Resistor", "Basic Electronic Component", o));
        // //wiring mv
        ...
        // ItemList.Circuit_Parts_Vacuum_Tube.set(addItem(tLastID = 13, "Vacuum Tube", "Basic Electronic Component",
        // o)); //Circuit_Primitive
        ...
        // ItemList.Circuit_Parts_Transistor.set(addItem(tLastID = 17, "Transistor", "Basic Electronic Component", o));
        // //wiring hv
        ItemList.Circuit_Parts_TransistorSMD.set(addItem(tLastID = 18, "SMD Transistor", "Electronic Component", o));
        // ItemList.Circuit_Parts_Capacitor.set(addItem(tLastID = 19, "Capacitor", "Electronic Component", o)); //wiring
        // ev
        ...
        ItemList.Circuit_Silicon_Ingot2
            .set(addItem(tLastID = 31, "Glowstone doped Monocrystalline Silicon Boule", "Raw Circuit", o));
        ...
        ItemList.Circuit_Chip_Stemcell
            .set(addItem(tLastID = 73, "Stemcells", "Raw Intiligence (Disassembled Eggs)", o));
        ...
        ItemList.Circuit_Crystalmainframe.set(
            addItem(
                ...
                "A Super Circuit",
                new Object[] { OrePrefixes.circuit.get(Materials.Superconductor), SubTag.NO_UNIFICATION }));
        ...
        ItemList.Circuit_Wetwaremainframe.set(
            addItem(
                ...
                "Wetware Mainframe",
                "An Infinite Circuit",
                new Object[] { OrePrefixes.circuit.get(Materials.Infinite), SubTag.NO_UNIFICATION }));
        ItemList.Circuit_Ultimate.set(ItemList.Circuit_Ultimatecrystalcomputer.get(1L, new Object[0]));// maybe should
                                                                                                       // be removed
    }
