...
public class ItemComb extends Item {
    ...
    public void initCombsRecipes() {
        ...
        addSpecialCent(
            ...
            70,
            GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Salt, 1),
            20,
            GT_OreDictUnificator.get(OrePrefixes.dust, Materials.RockSalt, 1),
            20);
        ...
        addSpecialCent(
            ...
            GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Stone, 1),
            50,
            GT_OreDictUnificator.get(OrePrefixes.dust, Materials.GraniteBlack, 1),
            20,
            GT_OreDictUnificator.get(OrePrefixes.dust, Materials.GraniteRed, 1),
            20);
        ...
        addProcess(tComb, Materials.Pyrite, 100);
        if (ProcessingModSupport.aEnableGCMarsMats) addProcess(tComb, Materials.MeteoricIron, 100);
    ...
    public void addSpecialCent(ItemStack tComb, ItemStack aOutput, int chance) {
        ...
        RecipeManagers.centrifugeManager.addRecipe(
            40,
            tComb,
            ImmutableMap.of(aOutput, chance * 0.01f, ItemList.FR_Wax.get(1, new Object[0]), 0.3f));
    }
    ...
    public void addSpecialCent(ItemStack tComb, ItemStack aOutput, int chance, ItemStack aOutput2, int chance2) {
        ...
        RecipeManagers.centrifugeManager.addRecipe(
            ...
            tComb,
            ImmutableMap
                .of(aOutput, chance * 0.01f, ItemList.FR_Wax.get(1, new Object[0]), 0.3f, aOutput2, chance2 * 0.01f));
    }
    ...
    public void addProcess(ItemStack tComb, Materials aInMaterial, Materials aOutMaterial, int chance) {
        if (GT_Mod.gregtechproxy.mNerfedCombs) {
            GT_Values.RA.addChemicalRecipe(
                ...
                Materials.Water.getFluid(1000),
                aInMaterial.mOreByProducts.isEmpty() ? null
                    : aInMaterial.mOreByProducts.get(0)
                        .getMolten(144),
