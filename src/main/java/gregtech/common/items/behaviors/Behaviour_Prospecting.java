    ...
    public boolean onItemUseFirst(GT_MetaBase_Item aItem, ItemStack aStack, EntityPlayer aPlayer, World aWorld, int aX,
        ...
        if ((tAssotiation != null) && (tAssotiation.mPrefix.toString()
            ...
            GT_Utility.sendChatToPlayer(
                aPlayer,
                trans("100", "This is ") + tAssotiation.mMaterial.mMaterial.mDefaultLocalName + trans("101", " Ore."));
        ...
        if (aBlock.isReplaceableOreGen(aWorld, aX, aY, aZ, Blocks.stone)
            ...
            if (GT_ModHandler.damageOrDechargeItem(aStack, this.mVanillaCosts, this.mEUCosts, aPlayer)) {
                GT_Utility.sendSoundToPlayers(
                    ...
                    aZ);
                int tMetaID = 0;
                int tQuality = (aItem instanceof GT_MetaGenerated_Tool)
                ...
                for (int i = 0, j = (int) (6 + tQuality); i < j; i++) {
                    ...
                    if (tBlock != aBlock) {
                        if (i < 4) GT_Utility
                            .sendChatToPlayer(aPlayer, trans("105", "Material is changing behind this Rock."));
                        break;
                    }
                }
                    ...
                    if ((tBlock instanceof GT_Block_Ores_Abstract)) {
                        ...
                        if ((tTileEntity instanceof GT_TileEntity_Ores)) {
                            ...
                            if ((tMaterial != null) && (tMaterial != Materials._NULL)) {
                                GT_Utility.sendChatToPlayer(
                                    aPlayer,
                                    trans("106", "Found traces of ") + tMaterial.mDefaultLocalName
                                        + trans("101", " Ore."));
                                return true;
                            }
                        }
                        ...
                        if ((tAssotiation != null) && (tAssotiation.mPrefix.toString()
                            ...
                            GT_Utility.sendChatToPlayer(
                                aPlayer,
                                trans("106", "Found traces of ") + tAssotiation.mMaterial.mMaterial.mDefaultLocalName
                                    + trans("101", " Ore."));
                            return true;
                        }
                    }
