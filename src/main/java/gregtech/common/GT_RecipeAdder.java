...
public class GT_RecipeAdder implements IGT_RecipeAdder {
    ...
    public boolean addFusionReactorRecipe(FluidStack aInput1, FluidStack aInput2, FluidStack aOutput1, int aDuration,
        ...
        if ((aOutput1 != null) && ((aDuration = GregTech_API.sRecipeFile.get(
            "fusion",
            aOutput1.getFluid()
                .getName(),
            aDuration)) <= 0)) {
    ...
    public boolean addCentrifugeRecipe(ItemStack aInput1, int aInput2, ItemStack aOutput1, ItemStack aOutput2,
        ...
        return addCentrifugeRecipe(
            aInput1,
            aInput2 < 0 ? ItemList.IC2_Fuel_Can_Empty.get(-aInput2, new Object[0])
    ...
    public boolean addChemicalRecipeForBasicMachineOnly(ItemStack aInput1, ItemStack aInput2, FluidStack aFluidInput,
        ...
        GT_Recipe.GT_Recipe_Map.sChemicalRecipes.addRecipe(
            ...
            aEUtick,
            0);
        // GT_Recipe.GT_Recipe_Map.sMultiblockChemicalRecipes.addRecipe(false, new ItemStack[]{aInput1, aInput2}, new
        // ItemStack[]{aOutput, aOutput2}, null, null, new FluidStack[]{aFluidInput}, new FluidStack[]{aFluidOutput},
        // aDuration, aEUtick, 0);
        return true;
    }
    ...
    public boolean addChemicalRecipe(ItemStack aInput1, ItemStack aInput2, FluidStack aFluidInput,
        ...
        GT_Recipe.GT_Recipe_Map.sChemicalRecipes.addRecipe(
            ...
            aDuration,
            aEUtick,
            isAddingDeprecatedRecipes ? -300 : 0);
    ...
    public void addDefaultPolymerizationRecipes(Fluid aBasicMaterial, ItemStack aBasicMaterialCell, Fluid aPolymer) {
        ...
        addChemicalRecipe(
            ...
            new GT_FluidStack(aBasicMaterial, 288),
            new GT_FluidStack(aPolymer, 288),
        ...
        addMultiblockChemicalRecipe(
            ...
            new FluidStack[] { new GT_FluidStack(aBasicMaterial, 2160), Materials.Air.getGas(15000),
    ...
    public boolean addFluidCannerRecipe(ItemStack aInput, ItemStack aOutput, FluidStack aFluidInput,
        ...
        GT_Recipe.GT_Recipe_Map.sFluidCannerRecipes.addRecipe(
            ...
            aFluidOutput == null ? aFluidInput.amount / 62 : aFluidOutput.amount / 62,
            1,
            0);
        return true;
    }
    ...
    public boolean addCrackingRecipe(FluidStack aInput, FluidStack aOutput, int aDuration, int aEUt) {
        ...
        // return false;
        // }
        // GT_Recipe.GT_Recipe_Map.sCrakingRecipes.addRecipe(true, null, null, null, null, new FluidStack[]{aInput}, new
        // FluidStack[]{aOutput}, aDuration, aEUt, 0);
        // GT_Recipe.GT_Recipe_Map.sCrakingRecipes.addRecipe(true, null, null, null, null, new FluidStack[]{aInput,
        // GT_ModHandler.getSteam(aInput.amount)}, new FluidStack[]{aOutput, Materials.Hydrogen.getGas(aInput.amount)},
        // aDuration, aEUt, 0);
        // GT_Recipe.GT_Recipe_Map.sCrakingRecipes.addRecipe(true, null, null, null, null, new FluidStack[]{aInput,
        // Materials.Hydrogen.getGas(aInput.amount)}, new FluidStack[]{new FluidStack(aOutput.getFluid(), (int)
        // (aOutput.amount * 1.3))}, aDuration, aEUt, 0);
        // return true;
        return false;
    }
    ...
    public boolean addAssemblylineRecipe(ItemStack aResearchItem, int aResearchTime, ItemStack[] aInputs,
        ...
        GT_Recipe.GT_Recipe_AssemblyLine.sAssemblylineRecipes.add(
            new GT_Recipe_AssemblyLine(aResearchItem, aResearchTime, aInputs, aFluidInputs, aOutput, aDuration, aEUt));
        return true;
    }
