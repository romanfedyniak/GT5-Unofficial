...
public abstract class GT_Proxy implements IGT_Mod, IGuiHandler, IFuelHandler {
    ...
    private static final EnumSet<OreGenEvent.GenerateMinable.EventType> PREVENTED_ORES = EnumSet.of(
        ...
        new OreGenEvent.GenerateMinable.EventType[] { OreGenEvent.GenerateMinable.EventType.IRON,
            OreGenEvent.GenerateMinable.EventType.GOLD, OreGenEvent.GenerateMinable.EventType.DIAMOND,
            OreGenEvent.GenerateMinable.EventType.REDSTONE, OreGenEvent.GenerateMinable.EventType.LAPIS,
    ...
    private final Collection<String> mIgnoredItems = new HashSet<String>(
        Arrays.asList(
            new String[] { "itemGhastTear", "itemFlint", "itemClay", "itemBucketSaltWater", "itemBucketFreshWater",
                ...
                "itemReedTypha", "itemSulfuricAcid", "itemPotash", "itemCompressedCarbon", "itemBitumen", "itemBioFuel",
                "itemCokeSugar", "itemCokeCactus", "itemCharcoalSugar", "itemCharcoalCactus", "itemSludge",
                "itemEnrichedAlloy", "itemQuicksilver", "itemMercury", "itemOsmium", "itemUltimateCircuit",
                "itemEnergizedStar", "itemAntimatterMolecule", "itemAntimatterGlob", "itemCoal", "itemBoat",
                "itemHerbalMedicineCake", "itemCakeSponge", "itemFishandPumpkinCakeSponge", "itemSoulCleaver",
                "itemInstantCake", "itemWhippingCream", "itemGlisteningWhippingCream", "itemCleaver",
                "itemHerbalMedicineWhippingCream", "itemStrangeWhippingCream", "itemBlazeCleaver",
    ...
    private final Collection<String> mIgnoredNames = new HashSet<String>(
        Arrays.asList(
            new String[] { "grubBee", "chainLink", "candyCane", "bRedString", "bVial", "bFlask", "anorthositeSmooth",
                "migmatiteSmooth", "slateSmooth", "travertineSmooth", "limestoneSmooth", "orthogneissSmooth",
                "marbleSmooth", "honeyDrop", "lumpClay", "honeyEqualssugar", "flourEqualswheat", "bluestoneInsulated",
                "blockWaterstone", "blockSand", "blockTorch", "blockPumpkin", "blockClothRock",
                "blockStainedHardenedClay", "blockQuartzPillar", "blockQuartzChiselled", "blockSpawner", "blockCloth",
                "mobHead", "mobEgg", "enderFlower", "enderChest", "clayHardened", "dayGemMaterial", "nightGemMaterial",
                "snowLayer", "bPlaceholder", "hardenedClay", "eternalLifeEssence", "sandstone", "wheatRice",
                "transdimBlock", "bambooBasket", "lexicaBotania", "livingwoodTwig", "redstoneCrystal",
                "pestleAndMortar", "glowstone", "whiteStone", "stoneSlab", "transdimBlock", "clayBowl", "clayPlate",
                "ceramicBowl", "ceramicPlate", "ovenRack", "clayCup", "ceramicCup", "batteryBox", "transmutationStone",
                "torchRedstoneActive", "coal", "charcoal", "cloth", "cobblestoneSlab", "stoneBrickSlab",
                "cobblestoneWall", "stoneBrickWall", "cobblestoneStair", "stoneBrickStair", "blockCloud", "blockDirt",
                "blockTyrian", "blockCarpet", "blockFft", "blockLavastone", "blockHolystone", "blockConcrete",
                "sunnariumPart", "brSmallMachineCyaniteProcessor", "meteoriteCoal", "blockCobble", "pressOreProcessor",
                "crusherOreProcessor", "grinderOreProcessor", "blockRubber", "blockHoney", "blockHoneydew", "blockPeat",
                "blockRadioactive", "blockSlime", "blockCocoa", "blockSugarCane", "blockLeather", "blockClayBrick",
                "solarPanelHV", "cableRedNet", "stoneBowl", "crafterWood", "brickXyEngineering", "breederUranium",
                "wireMill", "chunkLazurite", "aluminumNatural", "aluminiumNatural", "naturalAluminum",
                "naturalAluminium", "antimatterMilligram", "antimatterGram", "strangeMatter", "coalGenerator",
                "electricFurnace", "unfinishedTank", "valvePart", "aquaRegia", "leatherSeal", "leatherSlimeSeal",
                "hambone", "slimeball", "clay", "enrichedUranium", "camoPaste", "antiBlock", "burntQuartz", "salmonRaw",
                "blockHopper", "blockEnderObsidian", "blockIcestone", "blockMagicWood", "blockEnderCore",
                "blockHeeEndium", "oreHeeEndPowder", "oreHeeStardust", "oreHeeIgneousRock", "oreHeeInstabilityOrb",
                "crystalPureFluix", "shardNether", "gemFluorite", "stickObsidian", "caveCrystal", "shardCrystal",
                "dyeCrystal", "shardFire", "shardWater", "shardAir", "shardEarth", "ingotRefinedIron", "blockMarble",
                "ingotUnstable" }));
    private final Collection<String> mInvalidNames = new HashSet<String>(
        Arrays.asList(
            new String[] { "diamondShard", "redstoneRoot", "obsidianStick", "bloodstoneOre", "universalCable",
                "bronzeTube", "ironTube", "netherTube", "obbyTube", "infiniteBattery", "eliteBattery",
                "advancedBattery", "10kEUStore", "blueDye", "MonazitOre", "quartzCrystal", "whiteLuminiteCrystal",
                "darkStoneIngot", "invisiumIngot", "demoniteOrb", "enderGem", "starconiumGem", "osmoniumIngot",
                "tapaziteGem", "zectiumIngot", "foolsRubyGem", "rubyGem", "meteoriteGem", "adamiteShard", "sapphireGem",
                ...
                "blockWool", "alloyPlateEnergizedHardened", "gasWood", "alloyPlateEnergized", "SilverOre", "LeadOre",
                "TinOre", "CopperOre", "silverOre", "leadOre", "tinOre", "copperOre", "bauxiteOre",
                "HSLivingmetalIngot", "oilMoving", "oilStill", "oilBucket", "petroleumOre", "dieselFuel",
                "diamondNugget", "planks", "wood", "stick", "sticks", "naquadah", "obsidianRod", "stoneRod", "steelRod",
                "netherrackRod", "woodRod", "ironRod", "cactusRod", "flintRod", "copperRod", "cobaltRod", "alumiteRod",
                "blueslimeRod", "arditeRod", "manyullynRod", "bronzeRod", "boneRod", "slimeRod", "redalloyBundled",
    ...
    private static final void registerRecipes(OreDictEventContainer aOre) {
        ...
        if (aOre.mPrefix != null) {
            ...
            // System.out.println("Thingy Name: "+ aOre.mEvent.Name+ " !!!Unknown 'Thingy' detected!!! This Object seems
            // to probably not follow a valid OreDictionary Convention, or I missed a Convention. Please report to
            // GregTech Intergalactical for additional compatiblity. This is not an Error, an Issue nor a Lag Source, it
    ...
    public void onPreLoad() {
        ...
        ItemList.FR_Tree_Sapling.set(
            GT_ModHandler
                .getModItem(aTextForestry, "sapling", 1L, GT_ModHandler.getModItem(aTextForestry, "saplingGE", 1L)));
        ...
        ItemList.IC2_Fuel_Can_Empty.set(
            GT_ModHandler.getIC2Item(
                "fuelCan",
                1L,
        ...
        ItemList.IC2_PlantballCompressed
            .set(GT_ModHandler.getIC2Item("compressedPlantBall", 1L, ItemList.IC2_Plantball.get(1L, new Object[0])));
        ...
        GT_ModHandler.sNonReplaceableItems
            .add(GT_ModHandler.getModItem(aTextRailcraft, "part.turbine.disk", 1L, 32767));
        GT_ModHandler.sNonReplaceableItems
            .add(GT_ModHandler.getModItem(aTextRailcraft, "part.turbine.blade", 1L, 32767));
        GT_ModHandler.sNonReplaceableItems
            .add(GT_ModHandler.getModItem(aTextRailcraft, "part.turbine.rotor", 1L, 32767));
        ...
        GT_ModHandler.sNonReplaceableItems
            .add(GT_ModHandler.getModItem(aTextTwilightForest, "item.plateNaga", 1L, 32767));
        GT_ModHandler.sNonReplaceableItems
            .add(GT_ModHandler.getModItem(aTextTwilightForest, "item.legsNaga", 1L, 32767));
        GT_ModHandler.sNonReplaceableItems
            .add(GT_ModHandler.getModItem(aTextTwilightForest, "item.arcticHelm", 1L, 32767));
        GT_ModHandler.sNonReplaceableItems
            .add(GT_ModHandler.getModItem(aTextTwilightForest, "item.arcticPlate", 1L, 32767));
        GT_ModHandler.sNonReplaceableItems
            .add(GT_ModHandler.getModItem(aTextTwilightForest, "item.arcticLegs", 1L, 32767));
        GT_ModHandler.sNonReplaceableItems
            .add(GT_ModHandler.getModItem(aTextTwilightForest, "item.arcticBoots", 1L, 32767));
        GT_ModHandler.sNonReplaceableItems
            .add(GT_ModHandler.getModItem(aTextTwilightForest, "item.yetiHelm", 1L, 32767));
        GT_ModHandler.sNonReplaceableItems
            .add(GT_ModHandler.getModItem(aTextTwilightForest, "item.yetiPlate", 1L, 32767));
        GT_ModHandler.sNonReplaceableItems
            .add(GT_ModHandler.getModItem(aTextTwilightForest, "item.yetiLegs", 1L, 32767));
        GT_ModHandler.sNonReplaceableItems
            .add(GT_ModHandler.getModItem(aTextTwilightForest, "item.yetiBoots", 1L, 32767));
        GT_ModHandler.sNonReplaceableItems
    ...
    public void onPostLoad() {
        ...
        GT_OreDictUnificator.addItemData(
            ...
            new ItemData(Materials.Iron, 21772800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(
            new ItemStack(Items.wooden_door, 1, 32767),
            new ItemData(Materials.Wood, 21772800L, new MaterialStack[0]));
        for (FluidContainerRegistry.FluidContainerData tData : FluidContainerRegistry
            .getRegisteredFluidContainerData()) {
            if ((tData.filledContainer.getItem() == Items.potionitem) && (tData.filledContainer.getItemDamage() == 0)) {
                tData.fluid.amount = 0;
    ...
    public void onArrowLooseEvent(ArrowLooseEvent aEvent) {
        ...
        if ((!aEvent.isCanceled()) && (GT_Utility.isStackValid(aEvent.bow))
            ...
            aEvent.bow.getItem();
            aEvent.entityPlayer.worldObj
                .playSoundAtEntity(aEvent.entityPlayer, "random.bow", 1.0F, 0.64893958288F + tSpeed * 0.5F);
            ...
            if ((this.mSkeletonsShootGTArrows > 0) && (aEvent.entity.getClass() == EntityArrow.class)
                ...
                aEvent.entity.worldObj.spawnEntityInWorld(
                    new GT_Entity_Arrow(
                        ...
                        (ItemStack) OrePrefixes.arrowGtWood.mPrefixedItems
                    ...
                    if (Character.isUpperCase(firstChar) || Character.isLowerCase(firstChar) || firstChar == '_') {
                        if (aPrefix.mIsMaterialBased) {
                            ...
                            if (aMaterial != Materials._NULL) {
                                ...
                                switch (aPrefix) {
                                    ...
                                    case gem:
                                        if (aMaterial == Materials.Lapis || aMaterial == Materials.Sodalite) {
                                            ...
                                            } else if (aMaterial == Materials.Fluix || aMaterial == Materials.Quartz
                                ...
                                // System.out.println("Material Name: "+aEvent.Name+ " !!!Unknown Material detected!!!
                                // Please report to GregTech Intergalactical for additional compatiblity. This is not an
                                // Error, an Issue nor a Lag Source, it is just an Information, which you should pass to
                                // me.");
                                // GT_Log.ore.println(tModToName + " uses an unknown Material. Report this to
                                // GregTech.");
                                return;
                            }
                        } else {
                ...
                switch (aPrefix) {
                    ...
                    case plank:
                        if (tName.equals("Wood")) {
                            GT_OreDictUnificator
                                .addItemData(aEvent.Ore, new ItemData(Materials.Wood, 3628800L, new MaterialStack[0]));
                        }
                        break;
                    case slab:
                        if (tName.equals("Wood")) {
                            GT_OreDictUnificator
                                .addItemData(aEvent.Ore, new ItemData(Materials.Wood, 1814400L, new MaterialStack[0]));
                        }
                        break;
                    case sheet:
                            ...
                            && (((EntityLivingBase) tEntity).getHealth() > 0.0F)) {
                                ...
                                if (tList != null) {
                                    for (int j = 0; j < tList.size(); j++) {
                                        if ((tList.get(j) != null) && (tList.get(j)
                                            .getClass() == tClass)) {
                                            tEntityCount++;
                                        }
                                    }
    ...
    public void onPlayerTickEventServer(TickEvent.PlayerTickEvent aEvent) {
        if ((aEvent.side.isServer()) && (aEvent.phase == TickEvent.Phase.END) && (!aEvent.player.isDead)) {
            ...
            if (aEvent.player.ticksExisted % 10 == 0) {
                int tPollution = 0;
                tPollution = GT_Pollution.getPollution(
    ...
    public Object getServerGuiElement(int aID, EntityPlayer aPlayer, World aWorld, int aX, int aY, int aZ) {
        if (aID >= 1000) {
            ...
            switch (ID) {
                case 0:
                    return new ContainerBasicArmor(
                        aPlayer,
                        new InventoryArmor(ModularArmor_Item.class, aPlayer.getCurrentEquippedItem()));
                case 1:
                    return new ContainerElectricArmor1(
                        aPlayer,
                        new InventoryArmor(ModularArmor_Item.class, aPlayer.getCurrentEquippedItem()));
                case 2:
                    return new ContainerElectricArmor1(
        ...
        if (aID >= 100) {
            ...
            switch (ID) {
                case 0:
                    return new ContainerBasicArmor(
                        aPlayer,
                        new InventoryArmor(ModularArmor_Item.class, aPlayer.getEquipmentInSlot(tSlot)));
                case 1:
                    return new ContainerElectricArmor1(
                        aPlayer,
                        new InventoryArmor(ModularArmor_Item.class, aPlayer.getEquipmentInSlot(tSlot)));
    ...
    public Object getClientGuiElement(int aID, EntityPlayer aPlayer, World aWorld, int aX, int aY, int aZ) {
        if (aID >= 1000) {
            ...
            switch (ID) {
                case 0:
                    return new GuiModularArmor(
                        new ContainerBasicArmor(
                            aPlayer,
                            new InventoryArmor(ModularArmor_Item.class, aPlayer.getCurrentEquippedItem())),
                        aPlayer);
                case 1:
                    return new GuiElectricArmor1(
                        new ContainerElectricArmor1(
                            aPlayer,
                            new InventoryArmor(ModularArmor_Item.class, aPlayer.getCurrentEquippedItem())),
                        aPlayer);
                case 2:
    ...
    public Object getRightItemGui(EntityPlayer player, int ID) {
        ...
        switch (ID % 100) {
            case 0:
                return new GuiModularArmor(
                    new ContainerBasicArmor(player, new InventoryArmor(ModularArmor_Item.class, mStack)),
                    player);
            case 1:
                return new GuiElectricArmor1(
                    new ContainerElectricArmor1(player, new InventoryArmor(ModularArmor_Item.class, mStack)),
                    player);
            case 2:
                return new GuiElectricArmor1(
                    new ContainerElectricArmor1(player, new InventoryArmor(ModularArmor_Item.class, mStack)),
    ...
    public void addAutoGeneratedHydroCrackedFluid(Materials aMaterial) {
        ...
        Fluid crackedFluid = addFluid(
            "hydrocracked." + aMaterial.mName.toLowerCase(Locale.ENGLISH),
            uncrackedFluid.mTextureName,
            "Hydro-Cracked " + aMaterial.mDefaultLocalName,
            null,
            aMaterial.mRGBa,
            2,
            775,
        ...
        GT_Values.RA.addCrackingRecipe(
            ...
            new FluidStack(crackedFluid, 1000),
            20,
            120);
    ...
    public void addAutoGeneratedSteamCrackedFluid(Materials aMaterial) {
        ...
        Fluid crackedFluid = addFluid(
            "steamcracked." + aMaterial.mName.toLowerCase(Locale.ENGLISH),
            uncrackedFluid.mTextureName,
            "Steam-Cracked " + aMaterial.mDefaultLocalName,
            null,
            aMaterial.mRGBa,
            2,
            775,
                        ...
                        && tOre.mMaterial == Materials.Blizz) {
                            ...
                            && tOre.mMaterial == Materials.Pyrotheum) {
                                ...
                                GT_OreDictUnificator.set(
                                    ...
                                    true);
                                continue;
                            } else if (tOre.mModID.equalsIgnoreCase(aTextArsmagica2) && tOre.mPrefix == OrePrefixes.gem
    ...
    public void handleChunkSaveEvent(ChunkDataEvent.Save event) {// ALWAYS SAVE FROM THE HASH MAP DATA
        ...
        int[] tInts = chunkData.get(
            event.getChunk()
                .getChunkCoordIntPair());
        if (tInts == null) return;// no chunk data stored
        // assuming len of this array 4
        if (tInts[3] >= 0) event.getData()
            .setInteger("GTOIL", tInts[GTOIL]);
        else event.getData()
            .removeTag("GTOIL");
        if (tInts[2] >= 0) event.getData()
            .setInteger("GTOILFLUID", tInts[GTOILFLUID]);
        else event.getData()
            .removeTag("GTOILFLUID");
        if (tInts[1] > 0) event.getData()
            .setInteger("GTPOLLUTION", tInts[GTPOLLUTION]);
        else event.getData()
            .removeTag("GTPOLLUTION");
        event.getData()
            .setByte("GTOILVER", oilVer);// version mark
    }
    ...
    public void handleChunkLoadEvent(ChunkDataEvent.Load event) {
        ...
        if (tInts == null) {
            ...
            if (event.getData()
                .getByte("GTOILVER") == oilVer) {
                if (event.getData()
                    .hasKey("GTOIL"))
                    tInts[GTOIL] = event.getData()
                        .getInteger("GTOIL");
                if (event.getData()
                    .hasKey("GTOILFLUID"))
                    tInts[GTOILFLUID] = event.getData()
                        .getInteger("GTOILFLUID");
            }

            tInts[GTPOLLUTION] = event.getData()
                .getInteger("GTPOLLUTION");// Defaults to 0

            // store in HASH MAP if has useful data
            if (tInts[GTPOLLUTION] > 0 || tInts[GTOIL] >= 0 || tInts[GTOILFLUID] >= 0) chunkData.put(
                event.getChunk()
                    .getChunkCoordIntPair(),
                tInts);
            ...
            if (event.getData()
                .getByte("GTOILVER") == oilVer) {
                if (tInts[GTOIL] < 0 && event.getData()
                    .hasKey("GTOIL"))// if was not yet initialized
                    tInts[GTOIL] = event.getData()
                        .getInteger("GTOIL");

                if (tInts[GTOILFLUID] < 0 && event.getData()
                    .hasKey("GTOILFLUID"))// if was not yet initialized
                    tInts[GTOILFLUID] = event.getData()
                        .getInteger("GTOILFLUID");
            } else {
                tInts[GTOIL] = -1;
            ...
            tInts[GTPOLLUTION] += event.getData()
                .getInteger("GTPOLLUTION");// Defaults to 0, add stored pollution to data
