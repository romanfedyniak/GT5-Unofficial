...
public class GT_EnergyArmor_Item extends ItemArmor implements ISpecialArmor {
    ...
    public static Map<EntityPlayer, Float> jumpChargeMap = new ConcurrentHashMap<EntityPlayer, Float>();
        ...
        if (!var1.entity.worldObj.isRemote && var1.entity instanceof EntityPlayer) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (var3 != null && var3.getItem() == this && (mSpecials & 2) != 0) {
                    ...
                    if (var5 <= GT_ModHandler
                        .dischargeElectricItem(var3, Integer.MAX_VALUE, Integer.MAX_VALUE, true, true, true)) {
    ...
    public ISpecialArmor.ArmorProperties getProperties(EntityLivingBase var1, ItemStack var2, DamageSource var3,
        ...
        return new ISpecialArmor.ArmorProperties(
            (var3 == DamageSource.fall && (mSpecials & 2) != 0) ? 10 : 0,
            getBaseAbsorptionRatio() * mArmorAbsorbtionPercentage,
            mDamageEnergyCost > 0
                ? 25 * GT_ModHandler.dischargeElectricItem(var2, Integer.MAX_VALUE, Integer.MAX_VALUE, true, true, true)
                    / mDamageEnergyCost
                : 0);
    }
