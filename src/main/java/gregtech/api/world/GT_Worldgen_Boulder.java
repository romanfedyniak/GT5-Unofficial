...
public class GT_Worldgen_Boulder extends GT_Worldgen_Ore {
    ...
    public GT_Worldgen_Boulder(String aName, boolean aDefault, Block aBlock, int aBlockMeta, int aDimensionType,
        ...
        if (isGenerationAllowed(aWorld, aDimensionType, mDimensionType)
            ...
            for (int i = 0; i < mAmount; i++) {
                ...
                if (tBlock != null && tBlock.isOpaqueCube()
                    && aWorld.getBlock(tX, tY - 6, tZ)
                        .isAir(aWorld, tX, tY - 6, tZ)) {
