...
public class GT_Worldgen_Ore_Normal extends GT_Worldgen_Ore {
    ...
    public GT_Worldgen_Ore_Normal(String aName, boolean aDefault, Block aBlock, int aBlockMeta, int aDimensionType,
                                    ...
                                    if (var14b < 1.0F) {
                                        for (int var44 = var34; var44 <= var37; ++var44) {
                                            ...
                                            if (var14b + var45 * var45 < 1.0F
                                                && ((mAllowToGenerateinVoid && aWorld.getBlock(var38, var41, var44)
                                                    .isAir(aWorld, var38, var41, var44))
                                                    || (block != null && (block
                                                        .isReplaceableOreGen(aWorld, var38, var41, var44, Blocks.stone)
