 ...
 * Do NOT add Recipes using the Constructors inside this Class, The GregTech_API File calls the correct Functions for
 * these Constructors.
 * <p/>
...
public class GT_Recipe implements Comparable<GT_Recipe> {
    ...
    protected GT_Recipe(boolean aOptimize, ItemStack[] aInputs, ItemStack[] aOutputs, Object aSpecialItems,
        ...
        aInputs = GT_Utility.getArrayListWithoutTrailingNulls(aInputs)
            .toArray(new ItemStack[0]);
        aOutputs = GT_Utility.getArrayListWithoutTrailingNulls(aOutputs)
            .toArray(new ItemStack[0]);
        aFluidInputs = GT_Utility.getArrayListWithoutNulls(aFluidInputs)
            .toArray(new FluidStack[0]);
        aFluidOutputs = GT_Utility.getArrayListWithoutNulls(aFluidOutputs)
            .toArray(new FluidStack[0]);
        ...
        for (int i = 0; i < aInputs.length; i++) if (aInputs[i] != null && Items.feather.getDamage(aInputs[i]) != W)
        ...
        this(
            ...
            new ItemStack[] { aInput1,
                GT_ModHandler.getIC2Item(
                    "industrialTnt",
                    aInput2 > 0 ? aInput2 < 64 ? aInput2 : 64 : 1,
                    new ItemStack(Blocks.tnt, aInput2 > 0 ? aInput2 < 64 ? aInput2 : 64 : 1)) },
            new ItemStack[] { aOutput1, aOutput2 },
            null,
            null,
            null,
    ...
    public static class GT_Recipe_Map {
        ...
        public static final GT_Recipe_Map sByProductList = new GT_Recipe_Map(
            ...
            true,
            true);
        public static final GT_Recipe_Map sReplicatorFakeRecipes = new GT_Recipe_Map(
            ...
            true,
            true);
        public static final GT_Recipe_Map sOrganicReplicatorFakeRecipes = new GT_Recipe_Map(
            new HashSet<GT_Recipe>(1),
            "gt.recipe.organicreplicator",
            "Organic Replicator",
            null,
            RES_PATH_GUI + "basicmachines/OrganicReplicator",
            1,
            1,
            1,
            1,
            ...
            true,
            true);
        // public static final GT_Recipe_Map sAssemblylineFakeRecipes = new GT_Recipe_Map(new HashSet<GT_Recipe>(30),
        ...
        public static final GT_Recipe_Map sLaserEngraverRecipes = new GT_Recipe_Map(
            ...
            null,
            RES_PATH_GUI + "basicmachines/LaserEngraver",
            2,
            1,
            2,
            0,
        ...
        public static final GT_Recipe_Map sMixerRecipes = new GT_Recipe_Map(
            ...
            "Mixer",
            null,
            RES_PATH_GUI + "basicmachines/Mixer",
            4,
            1,
            1,
            0,
        ...
        public static final GT_Recipe_Map sAutoclaveRecipes = new GT_Recipe_Map(
            ...
            "Autoclave",
            null,
            RES_PATH_GUI + "basicmachines/Autoclave",
            1,
            1,
            1,
            1,
        ...
        public static final GT_Recipe_Map sFluidCannerRecipes = new GT_Recipe_Map_FluidCanner(
            ...
            null,
            RES_PATH_GUI + "basicmachines/FluidCannerNEI",
            1,
            1,
            1,
            0,
        ...
        public static final GT_Recipe_Map sCrakingRecipes = new GT_Recipe_Map(
            new HashSet<GT_Recipe>(50),
            "gt.recipe.craker",
            "Oil Cracker",
            null,
        ...
        public static final GT_Recipe_Map sCutterRecipes = new GT_Recipe_Map(
            ...
            "Cutting Saw",
            null,
            RES_PATH_GUI + "basicmachines/Cutter",
            1,
            2,
            1,
            1,
        ...
        protected GT_Recipe addRecipe(GT_Recipe aRecipe, boolean aCheckForCollisions, boolean aFakeRecipe,
            ...
            if (aCheckForCollisions
                && findRecipe(null, false, Long.MAX_VALUE, aRecipe.mFluidInputs, aRecipe.mInputs) != null) return null;
            return add(aRecipe);
        }
        ...
        public GT_Recipe add(GT_Recipe aRecipe) {
            ...
            for (FluidStack aFluid : aRecipe.mFluidInputs) if (aFluid != null) {
                ...
                tList.add(aRecipe);
                if (!mRecipeFluidNameMap.contains(
                    aFluid.getFluid()
                        .getName()))
        ...
        public boolean containsInput(ItemStack aStack) {
            return aStack != null && (mRecipeItemMap.containsKey(new GT_ItemStack(aStack))
                || mRecipeItemMap.containsKey(new GT_ItemStack(GT_Utility.copyMetaData(W, aStack))));
        }
            ...
            try {
                ...
                if (tRecipeOutputs != null) {
                    aRecipe = new GT_Recipe(
                        false,
                        new ItemStack[] { GT_Utility.copyAmount(1, aInputs[0]) },
                        tRecipeOutputs.toArray(new ItemStack[tRecipeOutputs.size()]),
                        null,
                        null,
                        null,
                        null,
            ...
            if (rRecipe == null) {
                if (ItemList.Shape_Mold_Name.isStackEqual(aInputs[0], false, true)) {
                    ...
                    rRecipe = new GT_Recipe(
                        false,
                        new ItemStack[] { ItemList.Shape_Mold_Name.get(0), GT_Utility.copyAmount(1, aInputs[1]) },
                        new ItemStack[] { tOutput },
                        null,
                        null,
                        null,
                ...
                if (ItemList.Shape_Mold_Name.isStackEqual(aInputs[1], false, true)) {
                    ...
                    rRecipe = new GT_Recipe(
                        false,
                        new ItemStack[] { ItemList.Shape_Mold_Name.get(0), GT_Utility.copyAmount(1, aInputs[0]) },
                        new ItemStack[] { tOutput },
                        null,
                        null,
                        null,
    ...
    public static class GT_Recipe_Map_LargeChemicalReactor extends GT_Recipe_Map {
        ...
        public GT_Recipe addRecipe(boolean aOptimize, ItemStack[] aInputs, ItemStack[] aOutputs, Object aSpecial,
            ...
            return addRecipe(
                new GT_Recipe_LargeChemicalReactor(
                    aOptimize,
                    aInputs,
                    aOutputs,
                    aSpecial,
        ...
        private static class GT_Recipe_LargeChemicalReactor extends GT_Recipe {
            ...
            protected GT_Recipe_LargeChemicalReactor(boolean aOptimize, ItemStack[] aInputs, ItemStack[] aOutputs,
                Object aSpecialItems, int[] aChances, FluidStack[] aFluidInputs, FluidStack[] aFluidOutputs,
                int aDuration, int aEUt, int aSpecialValue) {
                super(
                    aOptimize,
                    aInputs,
                    ...
                    if (i < 3) {
                        inputStacks.add(
                            new FixedPositionedStack(
                                GT_Utility.getFluidDisplayStack(this.mFluidInputs[i], true),
                                48 - i * 18,
                                23));
                    } else {
                        inputStacks.add(
            ...
            public ArrayList<PositionedStack> getOutputPositionedStacks() {
                ...
                for (int i = 0; i < fluidLimit; i++) {
                    outputStacks.add(
                        new FixedPositionedStack(
                            GT_Utility.getFluidDisplayStack(this.mFluidOutputs[i], true),
                            102 + i * 18,
                            23));
                }
    ...
    public static class GT_Recipe_Map_DistillationTower extends GT_Recipe_Map {
        ...
        public GT_Recipe addRecipe(boolean aOptimize, ItemStack[] aInputs, ItemStack[] aOutputs, Object aSpecial,
            ...
            int aSpecialValue) {
            return addRecipe(
                new GT_Recipe_DistillationTower(
                    aOptimize,
                    aInputs,
                    aOutputs,
                    aSpecial,
        ...
        private static class GT_Recipe_DistillationTower extends GT_Recipe {
            ...
            protected GT_Recipe_DistillationTower(boolean aOptimize, ItemStack[] aInputs, ItemStack[] aOutputs,
                Object aSpecialItems, int[] aChances, FluidStack[] aFluidInputs, FluidStack[] aFluidOutputs,
                int aDuration, int aEUt, int aSpecialValue) {
                super(
                    aOptimize,
            ...
            public ArrayList<PositionedStack> getInputPositionedStacks() {
                ...
                if (this.mFluidInputs.length > 0 && this.mFluidInputs[0] != null) {
                    inputStacks.add(
                        new FixedPositionedStack(GT_Utility.getFluidDisplayStack(this.mFluidInputs[0], true), 48, 52));
                }
                return inputStacks;
            }
            ...
            public ArrayList<PositionedStack> getOutputPositionedStacks() {
                ...
                for (int i = 0; i < fluidLimit; i++) {
                    ...
                    outputStacks.add(
                        new FixedPositionedStack(GT_Utility.getFluidDisplayStack(this.mFluidOutputs[i], true), x, y));
                }
