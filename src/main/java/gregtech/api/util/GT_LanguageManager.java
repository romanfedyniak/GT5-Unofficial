...
public class GT_LanguageManager {
    ...
    public static final HashMap<String, String> TEMPMAP = new HashMap<String, String>(),
        BUFFERMAP = new HashMap<String, String>(), LANGMAP = new HashMap<String, String>();
    ...
    public static String getTranslation(String aKey) {
        if (aKey == null) return E;
        String tTrimmedKey = aKey.trim(), rTranslation = LanguageRegistry.instance()
        ...
        if (GT_Utility.isStringInvalid(rTranslation)) {
            ...
            if (GT_Utility.isStringInvalid(rTranslation) || tTrimmedKey.equals(rTranslation)) {
                if (aKey.endsWith(".name")) {
                    ...
                    if (GT_Utility.isStringInvalid(rTranslation) || tTrimmedKey.substring(0, tTrimmedKey.length() - 5)
                        .equals(rTranslation)) {
                        return aKey;
                    }
                } else {
