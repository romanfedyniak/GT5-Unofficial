    ...
    public static void fillMap(FMLPreInitializationEvent aEvent) {
        ...
        while (true) {
            ...
            while (var5.hasNext()) {
                ...
                } else if ((((String) entry.getKey()).contains("blockores")
                    || ((String) entry.getKey()).contains("blockmetal")
                    || ((String) entry.getKey()).contains("blockgem")) && s.contains("material")) {
                    ...
                    try {
                        i = Integer.parseInt(
                            ((String) entry.getKey()).substring(
                                ...
                                ((String) entry.getKey()).length() - ".name".length()));
            ...
            while (true) {
                while (var5.hasNext()) {
                    ...
                    if (((String) entry.getKey()).contains("cable")) {
                        lServerNames.put(
                            ...
                            ((String) entry.getValue()).replace(
                                ...
                                ((String) entry.getKey()).substring(
                                    ...
                                    ((String) entry.getKey()).length() - ".01.name".length())));
                        ...
                        if (!((String) entry.getKey()).contains("_huge")
                            && !((String) entry.getKey()).contains("_large")
                            && !((String) entry.getKey()).contains("_nonuple")
                            && !((String) entry.getKey()).contains("_quadruple")
                            && !((String) entry.getKey()).contains("_small")
                            && !((String) entry.getKey()).contains("_tiny")) {
                            lServerNames.put(
                                (String) entry.getKey(),
                                ((String) entry.getValue()).replace(
                                    "material",
                                    ((String) entry.getKey()).substring(
                                        ...
                                        ((String) entry.getKey()).length() - ".name".length())));
                        } else if (!((String) entry.getKey()).contains("_huge")
                            && !((String) entry.getKey()).contains("_tiny")) {
                                if (!((String) entry.getKey()).contains("_large")
                                    && !((String) entry.getKey()).contains("_small")) {
                                    if (((String) entry.getKey()).contains("_nonuple")) {
                                        lServerNames.put(
                                            ...
                                            ((String) entry.getValue()).replace(
                                                ...
                                                ((String) entry.getKey()).substring(
                                                    "gt.blockmachines.gt_pipe_".length(),
                                                    ((String) entry.getKey()).length() - "_nonuple.name".length())));
                                        ...
                                        lServerNames.put(
                                            ...
                                            ((String) entry.getValue()).replace(
                                                ...
                                                ((String) entry.getKey()).substring(
                                                    "gt.blockmachines.gt_pipe_".length(),
                                                    ((String) entry.getKey()).length() - "_quadruple.name".length())));
                                    }
                                } else {
                                    lServerNames.put(
                                        (String) entry.getKey(),
                                        ((String) entry.getValue()).replace(
                                            ...
                                            ((String) entry.getKey()).substring(
                                                "gt.blockmachines.gt_pipe_".length(),
                                                ((String) entry.getKey()).length() - "_large.name".length())));
                                }
                            } else {
                                lServerNames.put(
                                    (String) entry.getKey(),
                                    ((String) entry.getValue()).replace(
                                        ...
                                        ((String) entry.getKey()).substring(
                                            "gt.blockmachines.gt_pipe_".length(),
                                            ((String) entry.getKey()).length() - "_tiny.name".length())));
                            }
                ...
                while (var5.hasNext()) {
                    ...
                    if (((String) entry.getKey()).contains("blockores")) {
                        ...
                        if (((String) entry.getKey()).contains("blockmetal")) {
                            ...
                            switch (i) {
                                case 1:
                                    mMats = new Materials[] { Materials.Adamantium, Materials.Aluminium,
                                        ...
                                        Materials.Arsenic, Materials.BatteryAlloy, Materials.Beryllium,
                                        Materials.Bismuth, Materials.BismuthBronze, Materials.BlackBronze,
                                        Materials.BlackSteel, Materials.BlueAlloy, Materials.BlueSteel,
                                        Materials.Brass };
                                    break;
                                case 2:
                                ...
                                case 3:
                                    mMats = new Materials[] { Materials.ElectrumFlux, Materials.Enderium,
                                        Materials.Erbium, Materials.Europium, Materials.Gadolinium, Materials.Gallium,
                                        Materials.Holmium, Materials.HSLA, Materials.Indium, Materials.Invar,
                                        Materials.Iridium, Materials.IronMagnetic, Materials.Kanthal };
                                    break;
                                case 4:
                                    mMats = new Materials[] { Materials.Lanthanum, Materials.Lead, Materials.Lutetium,
                                        Materials.Magnalium, Materials.Magnesium, Materials.Manganese,
                                        Materials.MeteoricIron, Materials.MeteoricSteel, Materials.Molybdenum,
                                ...
                                case 6:
                                    mMats = new Materials[] { Materials.Promethium, Materials.RedAlloy,
                                        ...
                                        Materials.Scandium, Materials.Silicon, Materials.Silver,
                                ...
                                case 7:
                                    mMats = new Materials[] { Materials.Sunnarium, Materials.Tantalum,
                                        Materials.Tellurium, Materials.Terbium, Materials.Thorium, Materials.Thulium,
                            ...
                            t = ((String) entry.getKey()).substring(
                            ...
                            switch (i) {
                                case 1:
                                    mMats = new Materials[] { Materials.Amber, Materials.Amethyst, Materials.BlueTopaz,
                                        ...
                                        Materials.Forcillium, Materials.GreenSapphire, Materials.Jasper };
                                    break;
                                case 2:
                                    mMats = new Materials[] { Materials.Lazurite, Materials.Lignite, Materials.Monazite,
                                        Materials.Niter, Materials.Olivine, Materials.Opal, Materials.Phosphorus,
                                        Materials.Quartzite, Materials.Tanzanite, Materials.GarnetRed, Materials.Ruby,
                                        Materials.Sapphire, Materials.Sodalite };
                                    break;
                                case 3:
                                    mMats = new Materials[] { Materials.Topaz, Materials.Blaze, Materials.GarnetYellow,
