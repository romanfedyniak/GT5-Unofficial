...
public abstract class GT_MetaTileEntity_Buffer extends GT_MetaTileEntity_TieredMachineBlock {
    ...
    public ITexture[][][] getTextureSet(ITexture[] aTextures) {
        ...
        ITexture tIcon = getOverlayIcon(), tOut = new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_PIPE_OUT),
            tUp = new GT_RenderedTexture(Textures.BlockIcons.ARROW_UP),
            tDown = new GT_RenderedTexture(Textures.BlockIcons.ARROW_DOWN),
            tLeft = new GT_RenderedTexture(Textures.BlockIcons.ARROW_LEFT),
            tRight = new GT_RenderedTexture(Textures.BlockIcons.ARROW_RIGHT);
        for (byte i = -1; i < 16; i++) {
